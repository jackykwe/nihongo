...
//     \item A sentence final particle is adds nuance to the sentence. の adds an explanatory nuance (@sec:noun-related-particles). よ adds a informational nuance (@sec:sentence-ending-particles). ね adds an agreement-expecting nuance (@sec:sentence-ending-particles).
...
//     \item い-adjectives: always end with 平仮名「い」that is #underline[not] part of a 漢字 word's pronunciation: it must literally be a 平仮名「い」. As examples, 好き、きれい（綺麗）、きらい（嫌い）are all not い-adjectives; they are な-adjectives. #textred[嫌い being a な-adjective has to do with 嫌い being derived from the verb 嫌う. #highlight[REVISIT FUTURE]]
...
// A *transitive verb* takes a direct object, while an *intransitive verb* does not take a direct object. _A *direct object_ is the person or thing that directly receives the action or effect of the verb. It answers the question "what" or "whom". #textred[(\textbf{CAUTION*: Using the "The subject verbed what?" as a test for transitivity is *not foolproof* and doesn't always work! It's merely a crutch. This is because certain verbs that are purely transitive in English can be expressed intransitively in Japanese (and vice versa).] An *indirect object* answers the question "for what", "of what", "to what", "for whom", "of whom", or "to whom" and accompanies a direct object.} #link("https://www.britannica.com/dictionary/eb/qa/Direct-and-Indirect-Objects")[(Source)]
...
//     Noun/な-adjective                    & 「」#textgreen[[だ]]                 & 「」#textgreen[だった]               & 「」#textgreen[じゃない]               & 「」#textgreen[じゃなかった]               & 学生、友達 \\ \midrule
//     な-adjective                         & 「」#textgreen[な]                   & 「」#textgreen[だった]               & 「」#textgreen[じゃない]               & 「」#textgreen[じゃなかった]               & 元気、綺麗、好き、#textred[嫌い]  \\ \midrule
//     \SetCell[r=3]{c,m} い-adjective      & 「」い                               & 「」#textblue[かった]                & 「」#textblue[くない]                  & 「」#textblue[くなかった]                  & 嬉しい、気持ち悪い、難しい \\*
//                                          & いい                                 & #textred[よ]#textblue[かった]        & #textred[よ]#textblue[くない]          & #textred[よ]#textblue[くなかった]          & \\*
//                                          & かっこいい                           & かっこ#textred[よ]#textblue[かった]  & かっこ#textred[よ]#textblue[くない]    & かっこ#textred[よ]#textblue[くなかった]    & \\ \midrule
//     \SetCell[r=11]{c,m} う-verb          & 「」　す                             & 「」#textblue[した]                  & 「」#textblue[さない]                  & 「」#textblue[さなかった]                  & 話す、出す \\*
...
//                                          & 「」　う                             & 「」#textblue[った]                  & 「」#textblue[わない]                  & 「」#textblue[わなかった]                  & 買う、#ruby[会][あ]う \\ \midrule
//     る-verb                              & 「」　る                             &「」　#textblue[た]                   & 「」　#textblue[ない]                  & 「」　#textblue[なかった]                  & いる、食べる、#ruby[出][で]る、見る* \\ \midrule
//     \SetCell[r=2]{c,m} Exception verb    & 「」する                             & 「」#textblue[した]                  & 「」#textblue[しない]                  & 「」#textblue[しなかった]                  & 勉強する、楽しみにする、質問をする \\*
//                                         %  & くる                                 & #textred[き]#textblue[た]            & #textred[こ]#textblue[ない]            & #textred[こ]#textblue[なかった]            & \\*
//                                          & #ruby[来][く]る                      & #textred[#ruby[来][き]]#textblue[た] & #textred[#ruby[来][こ]]#textblue[ない] & #textred[#ruby[来][こ]]#textblue[なかった] & \\ \bottomrule
// }
...
// \begin{itemize}
//     \item と: inclusive noun connector (exclusive listing or together-with). #textred[It is used _between_ nouns in a list, not as a marker at the end of each noun.] It is similar to 「も」 in terms of #underline[inclusivity]. It can also be used to show an #underline[action was done together] with something or someone.
...
//     \item や: noun vague listing connector. Similar to と, #textred[it is used _between_ nouns in a list, not as a marker at the end of each noun,] with the implied meaning that the list is non-exhaustive, and some items on the list may not apply. In English, this is like the "and/or, etc." constructs.
...
//     \item とか: vague listing particle (colloquial). Used exactly like や but in informal settings. #textred[It is used _between_ nouns in a list, not as a marker at the end of each noun.]
...
// {の particle usage summary. 「」 is a dictionary-form placeholder; [] is optional; #textgreen[green means additive] (without modifying the dictionary-form); #textblue[blue means substitutive] (modifies the dictionary-form). $^*$: だ is the optional declarative/assertive present state-of-being marker. **: だ is used in masculine responses. For explanatory の, #textred[な] is used by rule for both nouns and な-adjectives. \textlightgrey{Light grey ones are rarely used.}}  % caption
...
//                                            &                                       &                                             & *Present*                            & *Past*                                & *Present*                                   & *Past*                                    \\ \midrule
//     Possession                             & Noun                                  & 「」                                        & 「」#textgreen[の[だ]$^*$]                  & \textlightgrey{「」のだった}                 & \textlightgrey{「」のじゃない}                     & \textlightgrey{「」のじゃなかった}               \\ \midrule
//     \SetCell[r=2]{c,m} Generic noun        & \SetCell[r=1]{c,m} な-adjective       & 「」                                        & 「」#textred[な]#textgreen[の]              & 「」だった#textgreen[の]                     & 「」じゃない#textgreen[の]                         & 「」じゃなかった#textgreen[の]                   \\*
//                                            & \SetCell[r=1]{c,m} い-adjective/verb  & 「」                                        & 「」#textgreen[の]                          & 「」\<conj\>#textgreen[の]                     & 「」\<conj\>#textgreen[の]                           & 「」\<conj\>#textgreen[の]                         \\ \midrule
//     \SetCell[r=8]{c,m} Explanatory         & \SetCell[r=4]{c,m} Noun/な-adjective  & 「」                                        & 「」#textred[な]#textgreen[の[だ]$^{**]$。} & 「」だった#textgreen[の[だ]$^{**]$。}        & 「」じゃない#textgreen[の[だ]$^{**]$。}            & 「」じゃなかった#textgreen[の[だ]$^{**]$。}      \\*
...
//                                            &                                       &                                             & 「」#textgreen[#textred[な]んです。]        & 「」だった#textgreen[んです。]               & 「」じゃない#textgreen[んです。]                   & 「」じゃなかった#textgreen[んです。]             \\* \cmidrule[l]{2-7}
//                                            & \SetCell[r=4]{c,m} い-adjective/verbs & 「」                                        & 「」#textgreen[の[だ]$^{**]$。}             & 「」\<conj\>#textgreen[の[だ]$^{**]$。}        & 「」\<conj\>#textgreen[の[だ]$^{**]$。}              & 「」\<conj\>#textgreen[の[だ]$^{**]$。}            \\*
...
//                                            &                                       &                                             & 「」#textgreen[んです。]                    & 「」\<conj\>#textgreen[んです。]               & 「」\<conj\>#textgreen[んです。]                     & 「」\<conj\>#textgreen[んです。]                   \\ \midrule
//     \SetCell[r=4]{c,m} Special             & \SetCell[r=2]{c,m} Noun/な-adjective  & 「」                                        &                                             & \textlightgrey{「」#textred[な]んだった。}   & \textlightgrey{「」#textred[な]んじゃない。}       & \textlightgrey{「」#textred[な]んじゃなかった。} \\*
//                                            &                                       &                                             &                                             & \textwhite{「」\textwhite{な}んだったです。} & \textlightgrey{「」#textred[な]んじゃありません。} & \textwhite{「」\textwhite{な}んじゃなかった。}   \\* \cmidrule[l]{2-7}
//                                            & \SetCell[r=2]{c,m} い-adjective/verbs & 「」                                        &                                             & 「」#textgreen[んだった。]                   & 「」#textgreen[んじゃない。]                       & 「」#textgreen[んじゃなかった。]                 \\*
//                                            &                                       &                                             &                                             & \textwhite{「」んだったです。}               & 「」#textgreen[んじゃありません。]                 & \textwhite{「」んじゃなかったです。}             \\ \bottomrule
// }
...
//     \item い-adjectives: 「」い #sym.arrow 「」く
