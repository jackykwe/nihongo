...
= \ruby{動詞{どう|し} (verbs)} \label{appendix:verbs}
...
}  % inner specification options
{
    ...
    *Action* & *Cat.* & *Meaning* & *Notes* & *Action* & *Cat.* & *Meaning* & *Notes* \\
    ...
    #ruby[叩][たた]く & う & to (repeatedly) strike/hit/slap/tap/pat/clap (hands); to attack/criticise/flame an idea & also in Table~\ref{tbl:appendix-vocab-verbs-production}; #link("https://dictionary.goo.ne.jp/thsrs/1292/meaning/m0u/")[[goo]] & - & & & \\
...
}  % inner specification options
{
    ...
    *Action* & *Cat.* & *Meaning* & *Notes* & *Action* & *Cat.* & *Meaning* & *Notes* \\
    ...
    \vit #ruby[倒][たお]す & う & to knock down/turn on its side/recline & also in Table~\ref{tbl:appendix-vocab-verbs-conflict-and-resolution} & #ruby[倒][たお]れる & る & to fall/collapse (focus on ground); to fold/go bankrupt (organisation) & also in Table~\ref{tbl:appendix-vocab-verbs-conflict-and-resolution}; #link("https://ja.hinative.com/questions/22550436")[[HN]] \\
    % & & & & & & & \\
    \midrule
...
}  % inner specification options
{
    ...
    *Action* & *Cat.* & *Meaning* & *Notes* & *Action* & *Cat.* & *Meaning* & *Notes* \\
    ...
    \vit #ruby[破][やぶ]る & う & to tear/rip (paper/cloth); to break through (defences); to surpass (record) & #link("https://ja.hinative.com/questions/17387132")[[HN]]; also in Table~\ref{tbl:appendix-vocab-verbs-conflict-and-resolution} & #ruby[破][やぶ]れる & る & to break/collapse/be torn/worn out/ruined & \\
...
}  % inner specification options
{
    ...
    *Action* & *Cat.* & *Meaning* & *Notes* & *Action* & *Cat.* & *Meaning* & *Notes* \\
    ...
    % & & & & & & & \\
    \midrule
    - & & & & #ruby[寝][ね]る & る & to lie down/go to bed/sleep & also in Table~\ref{tbl:appendix-vocab-verbs-consumption}; #link("https://dictionary.goo.ne.jp/thsrs/1422/meaning/m0u/")[[goo]] \\
    - & & & & #ruby[睡][ねむ]る & う & to sleep; to rest in peace (euphemism)  & also in Table~\ref{tbl:appendix-vocab-verbs-consumption}; #link("https://dictionary.goo.ne.jp/thsrs/1422/meaning/m0u/")[[goo]] \\
...
}  % inner specification options
{
    ...
    *Action* & *Cat.* & *Meaning* & *Notes* & *Action* & *Cat.* & *Meaning* & *Notes* \\
    ...
    % & & & & & & & \\
    \midrule
    \vit #ruby[倒][たお]す & う & to kill/defeat/beat/overthrow & also in Table~\ref{tbl:appendix-vocab-verbs-directions} & #ruby[倒][たお]れる & る & to be killed (person)/fall (organisation) & also in Table~\ref{tbl:appendix-vocab-verbs-directions}; #link("https://ja.hinative.com/questions/22550436")[[HN]] \\
