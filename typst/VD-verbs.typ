...
}  % inner specification options
{
    ...
    \viteq \ruby{伏}{ふ}せる & る & to turn over/lay face down; to point/cast down (gaze/head) & also in Table~\ref{tbl:appendix-vocab-verbs-knowledge-truth-and-reality} & \ruby{伏}{ふ}せる & る & to lie flat on the ground & \\
    ...
    % & & & & & & & \\
    \midrule
    \vit \ruby{当}{あ}てる & る & to hit/put on/hold against; to apply (patch/eye-mask) & \href{https://ja.hinative.com/questions/3867085}{[HN]} & \ruby{当}{あ}たる & う & to be hit/strike (e.g.\ a target/lottery/by an ailment) & \\
    \vit \ruby{打}{う}つ & う & to hit/strike/beat/punch (strong) & \href{https://dictionary.goo.ne.jp/thsrs/1292/meaning/m0u/}{[goo]}; \href{https://ja.hinative.com/questions/3867085}{[HN]} & \ruby{打}{う}たれる & る & to be struck/beaten (strong) & \\
    \ruby{叩}{たた}く & う & to (repeatedly) strike/hit/slap/tap/pat/clap (hands); to attack/criticise/flame an idea & also in Table~\ref{tbl:appendix-vocab-verbs-production}; \href{https://dictionary.goo.ne.jp/thsrs/1292/meaning/m0u/}{[goo]} & - & & & \\
    \ruby{殴}{なぐ}る & う & to strike/hit/beat/punch someone & \href{https://dictionary.goo.ne.jp/thsrs/1292/meaning/m0u/}{[goo]} & - & & & \\
    ぶつ & う & to hit someone; strike/beat (stronger) & (\ruby{打}{ぶ}つ); \href{https://dictionary.goo.ne.jp/thsrs/1292/meaning/m0u/}{[goo]}; \href{https://ja.hinative.com/questions/4651279\#answer-39822392}{[HN]} & ？ & & & \\
...
}  % inner specification options
{
    ...
    \ruby{叩}{たた}く & う & to play (drum) & also in Table~\ref{tbl:appendix-vocab-verbs-physical} & - & & & \\
    % & & & & & & & \\
    \midrule
    ...
    - & & & & \ruby{空}{す}く & う & to become less crowded/thin out; to get empty & also in Table~\ref{tbl:appendix-vocab-verbs-health} \\
    % & & & & & & & \\
    \midrule
    \midrule
    ...
    \ruby{掃除}{そう|じ}する & E & to clean/sweep/dust/scrub & \href{https://dictionary.goo.ne.jp/thsrs/6207/meaning/m0u/}{[goo]} & - & & & \\
    \ruby{清掃}{せい|そう}する & E & to clean/clean-up/garbage collect & literary; \href{https://dictionary.goo.ne.jp/thsrs/6207/meaning/m0u/}{[goo]} & - & & & \\
...
}  % inner specification options
{
    ...
    \textbf{Action} & \textbf{Cat.} & \textbf{Meaning} & \textbf{Notes} & \textbf{Action} & \textbf{Cat.} & \textbf{Meaning} & \textbf{Notes} \\
    \midrule
    - & & & & \ruby{空}{す}く & う & to be hungry & also in Table~\ref{tbl:appendix-vocab-verbs-production} \\
...
}  % inner specification options
{
    ...
    \ruby{伏}{ふ}せる & る & to conceal (secret)/place in hiding (in ambush) & also in Table~\ref{tbl:appendix-vocab-verbs-physical} & - & & & \\
