...
#noun_table(
  ...
  [#ruby[数字][すう|じ]], [digit/numeral], [],
  [#ruby[絵文字][え|も|じ]], [emoji; pictorial symbol; ASCII art], [],
  // [], [], [],
  hline,
  [#ruby[当][あ]て#ruby[字][じ]], [kanji used as phonetic symbols instead of for meaning (e.g. #ruby[寿司][す|し])], [],
  [#ruby[義訓][ぎ|くん]], [reading of kanji by meaning instead of pronunciation], [],
  [#ruby[熟字訓][じゅく|じ|くん]], [reading of kanji compound whose constituent characters relate to meaning but not pronunciation (e.g. #rruby[昨日][きのう]、#rruby[大人][おとな]、#rruby[煙草][たばこ])], [],
  // [], [], [],
  hline,
  ...
  [#ruby[読][よ]み], [reading (of a #ruby[漢字][かん|じ], esp. #ruby[訓読][くん|よ]み)], [],
  ...
  // [], [], [],
  thickhline,
  [#ruby[◎][にじゅうまる]/#ruby[二重丸][に|じゅう|まる]], ["very good"/double circle], [],
  [#ruby[○][まる]/#ruby[丸][まる]], ["correct"/"good"/circle], [also in @tbl:appendix-vocab-nouns-amounts-and-sizes],
  ...
  [#ruby[原文][げん|ぶん]のまま], [sic], [(#ruby[原文][げん|ぶん]の#ruby[儘][まま])],
  // [], [], [],
)
...
#noun_table(
  ...
  "tbl:appendix-vocab-nouns-grammatical", // label
  ...
  [#ruby[通][どお]り{に/の}], [following/in accordance with], [#suffix, also in @tbl:appendix-vocab-nouns-places],
  // [], [], [],
)
...
#noun_table(
  ...
  "tbl:appendix-vocab-nouns-physical", // label
  [ため#ruby[息][いき]], [sigh], [],
  ...
  [#ruby[行動][こう|どう]], [taking action/act/conduct/behaviour], [also a verb],
  [ハグ], [hug], [],
...
- When describing something native to Japan, use Japanese ordering.
- When forming international and Western concepts, such as compass directions, use Western ordering (this is standardised by the World Meteorological Organisation). Note that secondary intercardinal directions take the form \<cardinal\>-\<secondary cardinal\>.
...
#noun_table(
  ...
  // [], [], [],
  thickhline,
  [#ruby[距離][きょ|り]], [distance/range/interval; difference/gap (e.g. in opinion); metric (mathematical)], [],
  [[お]そば], [near/close/beside/vicinity/proximity/besides/while], [(#ruby[側][そば]/#ruby[傍][そば]); [尊敬語]],
  // [], [], [],
  hline,
  [#ruby[遠回][とお|まわ]り], [detour/roundabout way], [],
  // [], [], [],
  hline,
  [#ruby[入店][にゅう|てん]], [entering a store/restaurant; becoming an employee at a store], [also a verb],
  // [], [], [],
  hline,
  ...
  // [], [], [],
  thickhline,
  [#ruby[昇進][しょう|しん]], [promotion in rank (of person)], [also a verb],
  [#ruby[昇格][しょう|かく]], [promotion in status (of person/institution)], [also a verb],
  [#ruby[昇任][しょう|にん]], [promotion/advancement (of person)], [also a verb],
  [#ruby[格上][かく|あ]げ], [upgrade/promotion in status], [also a verb],
  [#ruby[昇級][しょう|きゅう]], [upgrading/promotion/advancement in grade/class/rank], [also a verb],
...
#noun_table(
  ...
  [お#ruby[越][こ]し], [coming/going], [尊敬語],
  [#ruby[遠足][えん|そく]], [school trip/field trip/excursion/outing], [],
  [#ruby[外出][がい|しゅつ]], [going out/outing/leaving (one's home/office)], [also a verb],
  [ハシゴ], [going to several places in succession (e.g. barhopping)], [(#ruby[梯子][はし|ご]); also a verb],
  // [], [], [],
  hline,
  ...
  // [], [], [],
  thickhline,
  [#ruby[到着][とう|ちゃく]], [arrival], [also a verb],
...
#noun_table(
  ...
  // [], [], [],
  thickhline,
  [#ruby[街][まち]], [downtown/main street/road], [#link("https://ja.hinative.com/questions/252377")[[HN3]]],
  [#ruby[町][ちょう]/#ruby[町][まち]], [street/neighbourhood], [#link("https://ja.hinative.com/questions/17979737")[[HN1]], #link("https://hinative.com/questions/20251204")[[HN2]], #link("https://ja.hinative.com/questions/252377")[[HN3]]],
  [#ruby[通][とお]り], [street/road/avenue], [#link("https://ja.hinative.com/questions/252377")[[HN3]]],
  [#ruby[通][どお]り], [street/road/avenue; roughly/about], [#suffix, also in @tbl:appendix-vocab-nouns-grammatical],
  ...
  [[お]うち], [one's home/house/family/household (of speaker, by default)], [#link("https://japanese.stackexchange.com/questions/3726/what-is-the-difference-between-%E3%81%84%E3%81%88-and-%E3%81%86%E3%81%A1")[[SE]], also a pronoun, [尊敬語]],
  [#ruby[部屋][へ|や]], [room], [],
...
#noun_table(
  ...
  // [], [], [],
  hline,
  [#ruby[洗濯機][せん|たく|き]], [washing machine], [],
  // [], [], [],
)
...
#noun_table(
  ...
  [#ruby[汁][しる]], [juice/sap; soup/broth; dipping suace], [],
  ...
  [[お]だし], [dashi (Japanese soup stock made from fish and kelp)], [([お]#ruby[出汁][だ|し]); [丁寧語]],
  [#ruby[味噌][み|そ]], [miso, fermented soybeans condiment], [],
  ...
  [#ruby[食][しょく]パン], [(rectangular) loaf of bread], [],
...
#noun_table(
  ...
  [#rruby[今日][きょう]], [today (now)], [also an adverb],
  [#ruby[本日][ほん|じつ]], [today (now)], [also an adverb; formal],
  ...
  // [], [], [],
  thickhline,
  [#rruby[一昨年][おととし]], [two years ago (from now)], [casual, also an adverb],
  [#ruby[去年][きょ|ねん]], [last year (from now)], [casual, also an adverb],
  [#ruby[一昨年][いっ|さく|ねん]], [two years ago (from now)], [formal, also an adverb, #link("https://ja.hinative.com/questions/666233")[[HN]]],
  [#ruby[昨年][さく|ねん]], [last year (from now)], [formal, also an adverb],
...
#noun_table(
  ...
  [#ruby[今後][こん|ご]], [from now on (ongoing event)], [also an adverb],
  // [], [], [],
  hline,
  ...
  [#ruby[晩][ばん]], [evening/night], [also an adverb, #link("https://ja.hinative.com/questions/13398881")[[HN]]],
  [#ruby[今晩][こん|ばん]], [this evening/tonight], [],
  [#ruby[前夜][ぜん|や]], [last night/the previous night; the night before (festival, major event, etc.)], [],
  [#ruby[夜][よる]], [evening/night (slightly formal)], [also an adverb, #link("https://ja.hinative.com/questions/13398881")[[HN]]],
  ...
  // [], [], [],
  hline,
  [#ruby[数日][すう|じつ]], [few days], [],
  [#ruby[数日間][すう|じつ|かん]], [several day period], [],
  // [], [], [],
  hline,
  ...
  [#ruby[未来][み|らい]], [the future], [],
  [#ruby[将来][しょう|らい]], [future prospects (people/organisations/countries)], [also an adverb],
  [#ruby[過][す]ぎ], [past/after a point in time (e.g. waiting/now)], [also in @tbl:appendix-vocab-nouns-amounts-and-sizes],
  // [], [], [],
  hline,
...
- {こ, ど, あ, ど\} \times \{れ, いつ, なた, こ, ちら, っち} are pronouns
- {こ, ど, あ, ど\} \times \{の, んな} are pre-noun adjectivals
- {こ, ど, あ, ど\} \times \{う} are adverbs
...
#noun_table(
  ...
  [#ruby[誰][だれ]], [who], [],
  [どなた], [who; what is your name (どなた[#ruby[様][さま]]{ですか/でしょうか}。; [extra politeness and distance])], [尊敬語, feminine; #link("https://www.tofugu.com/japanese-grammar/konata-sonata-anata-donata/")[[TFG]]],
  [どちら[#ruby[様][さま]]], [who], [[尊敬語]],
  [どいつ], [who], [rude],
  [#ruby[誰][だれ]か], [somebody], [],
  [みんな[さん]], [everybody], [#ruby[皆][みんな]],
  [#ruby[誰][だれ]も], [nobody], [],
  ...
  [さん], [Mr./Mrs./Ms.], [#suffix, 尊敬語, familiar],
  [#ruby[殿][どの]], [Mr./Mrs./Ms. (in letters to inferiors)], [#suffix, 丁寧語],
  ...
  [あっち/[あちら]], [that person/foreign country (distant)], [丁寧語; [formal]],
  ...
  // [], [], [],
  hline,
  [そちら], [you/your family/your company], [丁寧語],
  ...
  [#rc(1, 3)[#textred[*THOU SHALT NOT CROSS THIS LINE*]]],
...
#noun_table(
  ...
  [#ruby[去][さ]る], [last/previous (〜◯#ruby[月][がつ])], [literary; also a verb],
...
#noun_table(
  ...
  [#ruby[少年][しょう|ねん]], [boy; juvenile/child (legal contexts)], [],
  [#ruby[未成年][み|せい|ねん]], [minor; not of age], [],
  [#ruby[成人][せい|じん]], [adult/grown-up (age); coming of age/becoming an adult], [also a verb],
  [#ruby[新成人][しん|せい|じん]], [new adult (a person in Japan who reaches adulthood at year)], [],
  [#rruby[大人][おとな]], [adult/grown-up (age and maturity)], [],
  // [], [], [],
  thickhline,
  ...
  [#ruby[元][もと]カレ], [ex-boyfriend], [(#ruby[元彼][もと|かれ])],
  [#ruby[彼女][かの|じょ]], [girlfriend], [also a pronoun],
  [#ruby[元彼女][もと|かの|じょ]], [ex-girlfriend], [],
  // [], [], [],
  thickhline,
  ...
  [お#ruby[客][きゃく]さん], [guest/visitor/customer/client/shopper/audience/tourist/sightseer/passenger], [尊敬語],
  [お#ruby[客様][きゃく|さま]], [guest/visitor/customer/client/shopper/audience/tourist/sightseer/passenger], [尊敬語],
  ...
  [#ruby[方][かた]], [person/lady/gentleman], [尊敬語; #link("https://ja.hinative.com/questions/78293")[[HN]]; also in @tbl:appendix-vocab-nouns-production],
  ...
  [#ruby[女好][おんな|ず]き], [woman admirer/lustful man; fondness for women; being attractive to women], [],
  ...
  [#ruby[芸人][げい|にん]], [comedian (esp. TV); entertainer/performer (esp. of traditional art)], [],
  [#ruby[美人][び|じん]], [beautiful woman/a beauty], [],
  [#ruby[未成年者][み|せい|ねん|しゃ]], [minor/underage person], [],
  // [], [], [],
  thickhline,
  ...
  [#ruby[禿][は]げ], [bald person/baldy; idiot/moron], [derogatory],
  [#ruby[迷惑者][めい|わく|もの]], [troublemaker/bothersome person/nuisance], [],
  // [], [], [],
)
...
#noun_table(
  ...
  [#ruby[夫婦][ふう|ふ]], [married couple/husband and wife], [#link("https://ja.hinative.com/questions/25177336")[[HN]]],
  [#ruby[夫妻][ふ|さい]], [married couple/husband and wife], [slightly formal; #link("https://ja.hinative.com/questions/25177336")[[HN]]],
  [#ruby[妻][つま]/[#ruby[奥][おく]さん]], [wife], [[尊敬語]],
  [#ruby[夫][おっと]/[ご#ruby[主人][しゅ|じん]]], [husband], [[尊敬語]],
  // [], [], [],
  hline,
  [#ruby[母][はは]/[お#ruby[母][かあ]さん]], [mother], [謙譲語/[尊敬語]],
  [#ruby[父][ちち]/[お#ruby[父][とう]さん]], [father], [謙譲語/[尊敬語]],
  [[ご]#ruby[両親][りょう|しん]], [parents], [[尊敬語]],
  [？/#ruby[祖父][そ|ふ]], [grandfather], [],
  [？/#ruby[祖母][そ|ぼ]], [grandmother], [],
  [#ruby[祖父母][そ|ふ|ぼ]], [grandparents], [],
  ...
  // [], [], [],
  hline,
  [#ruby[子][こ]ども[たち]], [children], [also in @tbl:appendix-vocab-nouns-roles-and-occupations],
  [#ruby[双子][ふた|ご]], [twins], [],
  [#ruby[娘][むすめ]\[さん\]], [daughter], [[尊敬語]],
  [#rruby[息子][むすこ]\[さん\]], [son], [[尊敬語]],
  // [], [], [],
  hline,
  [#ruby[兄弟][きょう|だい]], [siblings/brothers], [],
  [#ruby[男兄弟][おとこ|きょう|だい]], [brothers/male siblings], [],
  [#ruby[兄][あに]/[お#ruby[兄][にい]さん]], [older brother; young man/buddy/fella/lad], [[尊敬語]],
  [#ruby[兄貴][あに|き]], [older brother; one's senior; man older than oneself], [尊敬語],
  [ニキ], [bro (e.g. #ruby[海外][かい|がい]ニキ)], [#suffix; slang],
  [#ruby[弟][おとうと]\[さん\]], [younger brother], [[尊敬語]],
  // [], [], [],
  hline,
  [#ruby[姉妹][し|まい]], [sisters], [],
  [#ruby[女兄弟][おんな|きょう|だい]], [sisters/female siblings], [],
  [#ruby[姉][あね]/[お#ruby[姉][ねえ]さん]], [older sister; young lady/miss/ma'am/older girl], [[尊敬語]],
  [#ruby[妹][いもうと]\[さん\]], [younger sister], [[尊敬語]],
  // [], [], [],
  thickhline,
  [#ruby[独身者][どく|しん|しゃ]], [unmarried person/bachelor/spinster], [],
  [#ruby[独身][どく|しん]の#ruby[人][ひと]], [unmarried person/bachelor/spinster], [#link("https://www.instagram.com/reel/DDEfFdnSDEm/")[[IG]]],
  [#ruby[既婚][き|こん]], [married], [],
  [#ruby[既婚者][き|こん|しゃ]], [married person], [],
  [#ruby[未婚][み|こん]], [unmarried (not yet married)], [],
  [#ruby[未婚者][み|こん|しゃ]], [unmarried person (not yet married)], [],
  [#ruby[非婚][ひ|こん]], [unmarried (by choice)], [],
  [#ruby[離婚][り|こん]], [divorce], [also a verb],
  [バツ#ruby[１][いち]], [one-time divorcee (one "X" mark)], [(#ruby[罰一][ばつ|いち]); slang, jocular],
  [バツ#ruby[２][に]], [two-time divorcee (two "X" marks)], [(#ruby[罰二][ばつ|に]); slang, jocular],
  [バツ#ruby[３][さん]], [three-time divorcee (three "X" marks)], [(#ruby[罰三][ばつ|さん]); slang, jocular],
  // [], [], [],
)
...
#noun_table(
  ...
  [#ruby[呼吸][こ|きゅう]], [breathing/respiration], [also a verb],
  // [], [], [],
  hline,
  ...
  [お#ruby[腹][なか]], [belly/abdomen/stomach], [丁寧語],
  [お#ruby[腹][なか]の#ruby[子][こ]], [child one is expecting], [],
  // [], [], [],
  hline,
  [#ruby[上半身][じょう|はん|しん]], [upper half of the body], [],
  [#ruby[下半身][か|はん|しん]], [lower half of the body, nether parts], [],
  [けつ], [ass/buttocks], [(#ruby[穴][けつ]); slang],
  [[お]#ruby[尻][しり]], [bottom/buttocks], [[丁寧語]],
  ...
  [#ruby[脚][あし]], [leg], [],
  [#ruby[足首][あし|くび]], [ankle], [],
  [くるぶし], [ankle bone], [(#ruby[踝][くるぶし])],
  [#ruby[土踏][つち|ふ]まず], [arch of the foot], [],
  // [], [], [],
  thickhline,
...
#noun_table(
  ...
  [#ruby[気持][き|も]ち], [feeling/sensation/mood/state of mind], [],
  [#ruby[癇][かん]], [temper], [],
  [いい#ruby[気持][き|も]ち], [good feeling], [],
  [#ruby[嫌][いや]な#ruby[気持][き|も]ち], [unpleasant feeling], [],
  [#ruby[軽][かる]い#ruby[気持][き|も]ち], [casual], [technically an expression],
  [#ruby[気色][き|しょく]], [mood/humour], [],
  [#ruby[気分][き|ぶん]], [mood/feeling], [],
  [#ruby[感][かん]じ], [feeling/sense/impression], [],
  [いい#ruby[感][かん]じ], [pleasant feeling/good vibes], [],
  ...
  // [], [], [],
  thickhline,
  [#ruby[震][ふる]え], [shiver/tremble/quiver (e.g. cold/fear/rage)], [],
  [#ruby[緊張][きん|ちょう]], [nervousness/stress/tension/strain; tension (between countries/groups)], [also a verb],
  [#ruby[悩][なや]み], [troubles/worry/sorrows/anguish/agony], [],
  ...
  [#ruby[自慢][じ|まん]], [boast/bragging], [also a verb],
  [#ruby[努力][ど|りょく]], [effort/exertion/endeavour/hard work/striving], [also a verb],
  [#ruby[全力][ぜん|りょく]], [one's utmost, all of one's strength/energy/efforts], [],
  // [], [], [],
  hline,
  ...
  // [], [], [],
  hline,
  [#ruby[感動][かん|どう]], [being emotionally deeply moved/excited/inspired (internal emotions)], [also a verb],
  [#ruby[感激][かん|げき]], [deep emotion/impression/inspiration (stronger; with observable behaviour)], [also a verb],
  [#ruby[興奮][こう|ふん]], [excitement/stimulation/agitation/arousal], [also a verb],
  [#ruby[性的興奮][せい|てき|こう|ふん]], [sexual arousal/excitation], [],
  [#ruby[涙][なみだ]], [tears], [],
  ...
  [#ruby[悲喜][ひ|き]こもごも], [bittersweet], [(#ruby[悲喜][ひ|き]#ruby[交々][こも|ごも]), #yojijukugo],
  // [], [], [],
  hline,
  ...
  [#ruby[不幸][ふ|こう]], [unhappy/sorrowful/misfortunate/disastrous; bereavement/death (usu. of relative)], [#link("https://dictionary.goo.ne.jp/thsrs/5311/meaning/m0u/")[[HN]]],
...
#noun_table(
  ...
  [#ruby[仕方][し|かた]], [way/method/means towards a goal], [],
  [#ruby[方法][ほう|ほう]], [(a well-reasoned) way/method/process/procedure], [],
  [#ruby[手段][しゅ|だん]], [tool needed for going towards a goal], [],
  // [], [], [],
  hline,
  [#ruby[使用][し|よう]], [use/usage/application/employment/utilisation], [also a verb],
  ...
  // [], [], [],
  hline,
  [#ruby[中止][ちゅう|し]], [stoppage/interruption/discontinuation/suspension], [also a verb],
  ...
  [#ruby[修理][しゅう|り]], [repair/fixing/servicing], [also a verb],
  ...
  // [], [], [],
  hline,
  [#ruby[販売][はん|ばい]], [sales/selling/marketing], [also a verb],
  // [], [], [],
  hline,
  ...
  // [], [], [],
  hline,
  [まま], [remaining unchanged/in the same state], [(#ruby[儘][まま])],
  [\<v past\>まま], [with/while \<v past\> (e.g. eyes closed/lights on/standing/alive)], [(\<v past\>#ruby[儘][まま])],
  // [ままに], [], [],
  // [], [], [],
  hline,
  ...
  // [], [], [],
  hline,
  [#ruby[収益][しゅう|えき]], [revenue (organisation)], [],
  [#ruby[利潤][り|じゅん]], [profit (organisation)], [],
  [#ruby[利益][り|えき]], [profit; benefit/advantage/interests], [],
  [#ruby[設][もう]け], [profit], [informal],
  // [], [], [],
  thickhline,
  ...
  [#ruby[記入][き|にゅう]], [entry (in a form/register/diary)], [also a verb],
  [まとめ], [summary/aggregation], [],
  // [], [], [],
  hline,
  [#ruby[話][はなし]], [speech/talk/conversation/topic/subject], [],
  [ひそひそ#ruby[話][ばなし]], [whispering/whispered conversation], [],
  [タメ#ruby[口][ぐち]], [casual/informal speech/language], [slang],
  [しゃべり], [chat/chatter/talk], [(#ruby[喋][しゃべ]り)],
  [#ruby[雑談][ざつ|だん]], [chatting/idle talk], [also a verb],
  [#ruby[放送][ほう|そう]], [broadcast/program/announcement (TV/radio)], [also a verb; #link("https://hinative.com/questions/21999375")[[HN]]],
  [#ruby[配信][はい|しん]], [broadcast/distribution/streaming (Internet)], [also a verb; #link("https://hinative.com/questions/21999375")[[HN]]],
  [アドバイス], [advice], [also a verb],
  // [], [], [],
  hline,
  ...
  [#ruby[下][しも]ネタ], [dirty joke; indecent topic/bawdy subject/sex talk], [],
  // [], [], [],
  hline,
  [#ruby[音][おと]], [sound], [],
  [#ruby[音楽][おん|がく]], [music], [],
  ...
  // [], [], [],
  hline,
  [#ruby[管理][かん|り]], [management/control (act of)], [also a verb],
  // [], [], [],
  hline,
  [メンバ[ー]シップ], [membership], [],
  [#ruby[登録][とう|ろく]], [presence in register/records; registration/subscription (YouTube)], [also a verb],
  ...
  // [], [], [],
  thickhline,
  [#ruby[掃除][そう|じ]], [cleaning/sweeping/dusting/scrubbing], [also a verb],
  [#ruby[清掃][せい|そう]], [cleaning/clean-up/garbage collection], [literary; also a verb],
  [#ruby[洗濯][せん|たく]], [washing/laundry (act of washing)], [also a verb],
  [#ruby[洗濯物][せん|たく|もの]], [laundry (clothes to be washed)], [],
  // [], [], [],
)
...
#noun_table(
  ...
  [[お]#ruby[金][かね]], [money], [[丁寧語]],
  [#ruby[円][えん]], [yen (Japanese monetary unit)], [],
  [#ruby[購入][こう|にゅう]], [purchase/buying], [also a verb],
  ...
  [#ruby[燃焼][ねん|しょう]], [combustion/burning], [also a verb],
  // [], [], [],
  thickhline,
...
#noun_table(
  ...
  // [], [], [],
  thickhline,
  [[お]#ruby[願][ねが]い], [wish/desire/hope; request/favour], [[丁寧語]; also an interjection],
  [#ruby[応援][おう|えん]], [aid/assistance/help/support; cheering/rooting for], [],
  [〜#ruby[願][ねがい]], [written application], [#suffix],
  [#ruby[請求][せい|きゅう]], [request/application; claim], [also a verb; also in @tbl:appendix-vocab-nouns-consumption],
  [#ruby[感謝][かん|しゃ]], [thanks/gratitude/appreciation], [also a verb],
  [#ruby[大感謝][だい|かん|しゃ]], [great thanks/gratitude/appreciation], [also a verb],
  [#ruby[評価][ひょう|か]], [appreciation/recognition/praise], [also a verb; also in @tbl:appendix-vocab-nouns-ability],
  [お#ruby[礼][れい]], [thanks/gratitude], [丁寧語],
  ...
  [#ruby[選択][せん|たく]], [choice/selection/option], [also a verb],
  // [], [], [],
  hline,
  [#ruby[優先][ゆう|せん]], [priority/precedence/preference], [also a verb],
  // [], [], [],
  thickhline,
  [#ruby[絆][きずな]], [emotional ties/bonds/relationship/connection], [],
  // [], [], [],
  thickhline,
  ...
  // [], [], [],
  hline,
  [#ruby[存在][そん|ざい]], [existence/presence], [also a verb],
  ...
  [#ruby[自白][じ|はく]], [confession/admission (when questioned)], [also a verb],
  [#ruby[自供][じ|きょう]], [confession/admission (when questioned)], [also a verb],
  // [], [], [],
  hline,
  [#ruby[逮捕][たい|ほ]], [arrest/capture], [also a verb],
  // [], [], [],
  thickhline,
  [#ruby[機会][き|かい]], [chance/opportunity], [also: チャンス],
  // [], [], [],
  hline,
...
#noun_table(
  ...
  [#ruby[精神病][せい|しん|びょう]], [mental illness/psychosis], [],
  ...
  [#ruby[疲労困憊][ひ|ろう|こん|ぱい]], [total exhaustion], [#yojijukugo; also a verb],
  ...
  // [], [], [],
  hline,
  [#ruby[急性][きゅう|せい]], [acute (illness)], [],
  [#ruby[慢性][まん|せい]], [chronic (illness)], [],
  [#rruby[風邪][かぜ]], [common cold/flu/influenza/inflammatory respiratory system illness (generic)], [],
  [たん], [phlegm/sputum], [(#ruby[痰][たん])],
  // [], [], [],
  hline,
  [#ruby[薬][くすり]], [medicine/pill/ointment], [],
  [#ruby[絆創膏][ばん|そう|こう]], [adhesive bandage/sticking plaster/band-aid], [],
  // [], [], [],
  hline,
  ...
  [#ruby[夢中][む|ちゅう]], [within a dream/while dreaming], [also an adjective],
  // [], [], [],
  hline,
...
#noun_table(
  ...
  // [], [], [],
  hline,
  [#rruby[八重][やえ]], [overlapping/multilayered/doubled (e.g. of flower petals)], [#link("https://ja.wikipedia.org/wiki/%E5%85%AB%E9%87%8D")[[Wiki]]],
  // [], [], [],
)
...
#noun_table(
  ...
  // [], [], [],
  thickhline,
  [#ruby[特徴][とく|ちょう]], [distinguishing feature], [],
  [#ruby[特長][とく|ちょう]], [strong point/forte/merit/strength], [],
  [#ruby[特色][とく|しょく]], [superior feature], [],
  // [], [], [],
  hline,
  [#ruby[魅力][み|りょく]], [charm/attraction/appeal (living/non-living)], [#link("https://ja.hinative.com/questions/19808144")[[HN]]],
  [#ruby[愛嬌][あい|きょう]], [charm/attractiveness/cuteness (living); courtesy], [#link("https://ja.hinative.com/questions/19808144")[[HN]]],
  [#ruby[味][あじ]], [charm/appeal/uniqueness/attractiveness], [also in @tbl:appendix-vocab-nouns-five-senses],
  // [], [], [],
  thickhline,
  [ずぶ#ruby[濡][ぬ]れ], [dripping wet/soaked/drenched], [],
...
#noun_table(
  ...
  // [], [], [],
  thickhline,
  [#ruby[独立][どく|りつ]], [independence/self-reliance], [also a verb],
  // [], [], [],
  thickhline,
  ...
  // [], [], [],
  thickhline,
  [#ruby[受][う]け], [reception/popularity/reputation], [],
  [#ruby[評価][ひょう|か]], [rating/valuation/appraisal/evaluation/assessment], [also a verb; also in @tbl:appendix-vocab-nouns-interaction],
  [#ruby[再評価][さい|ひょう|か]], [revaluation/reassessment/reappraisal/reevaluation], [also a verb],
  [#ruby[高評価][こう|ひょう|か]], [high rating/good reputation], [],
  [#ruby[低評価][てい|ひょう|か]], [low rating/bad repuation], [],
...
#noun_table(
  ...
  [#ruby[謎][なぞ]], [riddle/puzzle/enigma/mystery], [],
  [なぞなぞ], [ridle/puzzle/enigma], [(#ruby[謎々][なぞ|なぞ])],
  // [], [], [],
  hline,
  ...
  [#ruby[同][おな]じくらい], [approximately the same], [actually an expression],
  ...
  [#ruby[誤解][ご|かい]], [misunderstanding (objective concept)], [also a verb],
  [#ruby[勘違][かん|ちが]い], [erroneous assumption/thought illusion/misunderstanding/mistaken idea], [also a verb],
  [#ruby[思][おも]い#ruby[違][ちが]い], [mistaken idea/misconception ("thoughts different")], [also a verb],
  [#ruby[心得違][こころ|え|ちが]い], [imprudence/mistaken idea that is a misbehaviour (used disapprovingly in criticism)], [],
  [#ruby[人][ひと]#ruby[違][ちが]い], [mistaking one person for another], [also a verb],
  // [], [], [],
  thickhline,
...
#noun_table(
  ...
  [#ruby[思][おも]い], [thought], [],
  [#ruby[提案][てい|あん]], [proposal/proposition/suggestion], [also a verb],
  [#ruby[名案][めい|あん]], [good idea], [],
  [#ruby[回転][かい|てん]], [function/working (of one's mind)], [also a verb],
  // [], [], [],
  thickhline,
  [#ruby[情報][じょう|ほう]], [information/news/intelligence], [],
  [#ruby[消息][しょう|そく]], [news from someone; someone's whereabouts/movements], [],
  [#ruby[知][し]らせ], [news; notice/notification], [],
  [お#ruby[知][し]らせ], [notice/notification], [丁寧語],
  [#ruby[情報提供][じょう|ほう|てい|きょう]], [provision of information], [],
  [#ruby[状態][じょう|たい]], [(internal) state/condition/situation/appearance], [#link("https://ja.hinative.com/questions/15214608")[[HN3]]],
  [#ruby[状況][じょう|きょう]], [(surrounding) state of affairs/situation/circumstances (neutral, broader usage)], [#link("https://ja.hinative.com/questions/19291463")[[HN1]], #link("https://ja.hinative.com/questions/121430")[[HN2]], #link("https://ja.hinative.com/questions/15214608")[[HN3]]],
  [#ruby[事態][じ|たい]], [immediate situation/present state of affairs (usually negative)], [#link("https://ja.hinative.com/questions/19291463")[[HN1]], #link("https://ja.hinative.com/questions/121430")[[HN2]]],
  [#ruby[事情][じ|じょう]], [circumstances/conditions/matters (used to explain context/decision/event)], [#link("https://ja.hinative.com/questions/121430")[[HN]]],
  ...
  [ご#ruby[存知][ぞん|じ]], [knowledge/awareness], [尊敬語],
  [#ruby[断][ことわ]り], [rejection/refusal/declination; permission/consent; notification/notice], [],
  [お#ruby[断][ことわ]り], [rejection/refusal/declination; announcement/notice], [丁寧語],
  // [], [], [],
  hline,
  ...
  [#ruby[分析][ぶん|せき]], [analysis], [also a verb],
  ...
  // [], [], [],
  hline,
  [#ruby[発見][はっ|けん]], [discovery/detection/finding], [also a verb],
  [#ruby[発明][はつ|めい]], [invention], [also a verb],
  // [], [], [],
  hline,
  [#ruby[確定][かく|てい]], [decision (clear)], [also a verb],
  [#ruby[内定][ないう|てい]], [{informal/internal/unofficial\} \{decision/offer (e.g. job)}], [also a verb],
  [#ruby[本決][ほん|ぎ]まり], [formal/official final decision], [],
  [#ruby[未定][み|てい]], [not decided/not yet fixed/undecided/pending/TBC], [also an adjective],
  [#ruby[所定][しょ|てい]], [predetermined/prescribed/designated/fixed in advance], [],
  [#ruby[暫定][ざん|てい]], [provisional/tentative decision], [],
  [#ruby[予定][よ|てい]], [plans/arrangement/decision made in advance], [],
  [#ruby[既定][き|てい]], [decided/established/fixed/prearranged/predetermined], [],
  // [], [], [],
  hline,
  [#ruby[決断][けつ|だん]], [decision (strong)], [also a verb],
  [#ruby[決定][けっ|てい]], [decision], [also a verb],
  [#ruby[判断][はん|だん]], [judgment], [also a verb],
  [#ruby[断][だん]], [judgment], [literary],
  [#ruby[判定][はん|てい]], [verdict/ruling/judgment (of judge/referee)], [also a verb],
  [#ruby[断定][だん|てい]], [assertion/declaration/conclusion], [also a verb],
  // [], [], [],
  thickhline,
  ...
  // [], [], [],
  hline,
  [#ruby[疑][うたが]い], [doubt/question/uncertainty/skepticism/suspicion/distrust], [],
  // [], [], [],
)
...
#noun_table(
  ...
  // [], [], [],
  hline,
  [#ruby[無視][む|し]], [disregarding/ignoring], [also a verb],
  // [], [], [],
  thickhline,
  [#ruby[面倒][めん|どう]], [trouble/bother (when there's too much to do)], [#link("https://ja.hinative.com/questions/13515518")[[HN]]],
  [#ruby[迷惑][めい|わく]], [trouble/bother/annoyance/nuisance/inconvenience (to other people)], [#link("https://ja.hinative.com/questions/13515518")[[HN]]],
  // [], [], [],
  thickhline,
...
#noun_table(
  ...
  [#ruby[決戦][けっ|せん]], [decisive battle/deciding match], [also a verb],
  [#ruby[攻][せ]め], [attack/assault/offence], [],
  [#ruby[戦争][せん|そう]], [war], [],
  [#ruby[戦闘][せん|とう]], [battler/fight/combat], [],
  [#ruby[大戦][たい|せん]], [great war/battle; world war (abbreviation)], [],
  [#ruby[世界大戦][せ|かい|たい|せん]], [world war], [],
  [#ruby[第一次世界大戦][だい|いち|じ|せ|かい|たい|せん]], [World War I], [],
  [#ruby[第二次世界大戦][だい|に|じ|せ|かい|たい|せん]], [World War II], [],
  // [], [], [],
  hline,
  ...
  // [], [], [],
  thickhline,
  [#ruby[不正][ふ|せい]], [injustice/unfairness/wrongdoing/dishonestly/illegality/fraud], [also an adjective],
  // [], [], [],
  hline,
  [#ruby[脅][おど]し], [threat], [],
  // [], [], [],
  ...
  [#ruby[侮辱][ぶ|じょく]], [insult/slight/contempt (of court)], [also a verb],
  [#ruby[揉][も]め], [dispute/quarrel/disagreement], [],
  ...
  [#ruby[尋問][じん|もん]], [interrogation/questioning], [also a verb],
  [#ruby[罰][ばつ]], [punishment/penalty], [also a verb],
  // [], [], [],
  thickhline,
  [#ruby[自殺][じ|さつ]], [suicide], [also a verb],
  // [], [], [],
)
...
#noun_table(
  ...
  [〜#ruby[過][す]ぎ], [too much/over- (e.g. eating)], [#suffix, also in @tbl:appendix-vocab-nouns-time],
  ...
  [#ruby[最多][さい|た]], [most (numerous)/largest number of/maximum], [],
  // [], [], [],
  hline,
  [#ruby[丸][まる]], [entirety/whole/full/complete (as in, took a whole X days)], [#prefix; also in @tbl:appendix-vocab-nouns-meta-language],
  [#ruby[全体][ぜん|たい]], [whole/entirety], [],
  ...
  [#ruby[個人][こ|じん]], [individual/personal/private person], [],
  // [], [], [],
  thickhline,
  [#ruby[全員][ぜん|いん]], [all members/everyone], [also an adverb],
  // [], [], [],
  thickhline,
  [#rruby[彼方][かなた]], [beyond/across/the other side/the distance], [],
  [はるかかなた], [faraway], [(#ruby[遥][はる]か#ruby[彼][かな]方)],
  // [], [], [],
)
...
#noun_table(
  ...
  [#ruby[幻][まぼろし]], [phantom/vision/illusion], [],
  // [], [], [],
  hline,
  ...
  [おばけ], [ghost; goblin/monster/demon], [(お#ruby[化][ば]け)],
  [#ruby[化物][ばけ|もの]], [monster/goblin], [],
  // [], [], [],
  hline,
...
#noun_table(
  ...
  [#ruby[雪][ゆき]], [snow], [],
  [#ruby[虹][にじ]], [rainbow], [],
  [#ruby[湿気][しっ|け]], [humidity; moisture/dampness], [],
  // [], [], [],
  thickhline,
...
#noun_table(
  ...
  // [], [], [],
  thickhline,
  [オングストローム], [angstrom (1 Å = $qty("1e-10", "m")$)], [],
  ...
  [#ruby[海里][かい|り]/ノーティカルマイル], [nautical mile (1 nmi = 1852 m)], [],
  // [], [], [],
  hline,
  [#ruby[平方][へい|ほう]メートル], [square metre], [],
  [ヘクタール/㌶], [hectare (1 ha = $qty("10000", "m^2") = qty("0.01", "km^2")$)], [],
  [#ruby[平方][へい|ほう]キロメートル], [square kilometre ($qty("1", "km^2") = qty("1000000", "m^2")$)], [],
  [エーカー/㌈], [acre (1 ac = 4840 sq yd = 43560 sq ft = $1/640$ sq mile)], [],
  // [], [], [],
  hline,
  [ヘルツ/㌹], [hertz ($qty("1", "Hz") = qty("1", "/s")$)], [],
  [ノット/㌩], [knot (1 kt = 1 nmi$qty("", "/h")$)], [],
  ...
  [リットル/㍑], [litre ($qty("1", "L") = qty("1000", "cm^3") = qty("0.001", "m^3")$)], [],
  [ガロン/㌎], [gallon (there's a US one and a UK one..., both $lt.tilde qty("5", "L")$)], [],
  [#ruby[立方][りっ|ぽう]メートル], [cubic metre], [],
  // [], [], [],
  hline,
  [ジュール], [joule ($qty("1", "J") = qty("1", "kg m^2/s^2")$; $W = F dot s$; $F = m a$)], [],
  [カロリー/㌍], [calorie ($approx qty("4.184", "J")$)], [],
  [メガトン/㍌], [megaton (TNT equivalent)], [],
  [キロワット#ruby[時][じ]], [kilowatt hour (kW#h(0.166667em)h)], [],  // value 0.166667em from qty() function
  [ワット/㍗], [watt ($qty("1", "W") = qty("1", "J/s")$; $P = E/t$)], [],
  [キロワット/㌗], [kilowatt], [],
  // [], [], [],
  hline,
  [アンペア/㌂], [ampere], [],
  [クーロン], [coulomb ($qty("1", "C") = qty("1", "A/s")$)], [],
  [ボルト/㌾], [volt ($qty("1", "V") = qty("1", "J/C")$; $V = E/Q$)], [],
  [オーム/おーむ], [ohm ($qty("1", "ohm") = qty("1", "V/A")$; $R = V/I$)], [],
  [ファラッド/㌲], [farad (capacitance; $qty("1", "farad") = qty("1", "C/V")$)], [],
  // [], [], [],
  hline,
