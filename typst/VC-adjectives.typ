...
}  % inner specification options
{
    ...
    *Descriptor* & *Cat.* & *Meaning* & *Notes* \\
    ...
    \midrule
    \midrule
    おかしい & い & crazy/eccentric & (#rruby[可笑][おか]しい); also in Table~\ref{tbl:appendix-vocab-adjectives-knowledge-truth-and-reality} \\
    % & & & \\
    \midrule
    \midrule
...
}  % inner specification options
{
    ...
    *Descriptor* & *Cat.* & *Meaning* & *Notes* \\
    ...
    % & & & \\
    \midrule
    おかしい & い & laughable/ridiculous/strange/weird/suspicious & (#rruby[可笑][おか]しい); also in Table~\ref{tbl:appendix-vocab-adjectives-personalities} \\
