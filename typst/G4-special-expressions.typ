...
// The causative form of verbs indicate that someone _was made to_ perform the verb. It has two senses: making somebody do something, and letting someone to do something. #textred[Disa\documentclass[../nihongo-gakushuu-kyouzai-grammar.tex]{subfiles}
// \begin{document}
...
//     E.g. \st{私は#textred[本に]頭に落ちられた。 (My head was fallen on by a book.; #link("https://www.tofugu.com/japanese-grammar/verb-passive-form-rareru\#direct-vs-indirect-passive")[[TFG1]]) #textred[Unnatural sentence: the performer should not be an object.]}
...
//     \item (#highlight[???] voice, honorific, \S#highlight[???]) どうなさいますか。
//     \item (#highlight[???] voice, honorific, less certainty, \S#highlight[???]) どうなさいますでしょうか。
// \end{enumerate}
...
// \begin{enumerate}[label=\arabic*.]
//     \item 私は部長に*#ruby[褒][ほ]められました*。 (I was praised by my boss.; #ruby[褒][ほ]める: to praise (transitive))

//     私は部長に仕事を*#ruby[頼][たの]まれました*。 (I was requested by my boss to do work.; #ruby[頼][たの]む: to request/entrust to (transitive))

//     \item 私は誰かに足を*踏まれました*。 (My foot was stepped on by someone. #ruby[踏][ふ]む: to step on (transitive))
...
//     \item この#ruby[美術館][び|じゅつ|かん]は来月*#ruby[壊][こわ]されます*。 (This art museum will be demolished next month.; #ruby[壊][こわ]す: to break/demolish (transitive))

//     この#ruby[美術館][び|じゅつ|かん]は２００年前に*#ruby[建][た]てられました*。 (#ruby[建][た]てる: to construct (transitive))

//     \item 日本の車はいろいろな国へ*#ruby[輸出][ゆ|しゅつ]されています*。 (Japanese cars are exported to many countries.; #ruby[輸出][ゆ|しゅつ]する: to export (transitive))
...
// \begin{enumerate}[label=\arabic*.]
//     \item 私は先生に*呼ばれました*。 (I was called by my teacher.; 呼ぶ: to call out to (transitive))
...
//     \item 大阪で会議が*開かれます*。 (The meeting is held in Osaka.; #ruby[開][あ]く: to open (business) (intransitive))
...
//         \item _Adversative nuance is not guaranteed (depends on the passivised verb)._
...
//         \item _Adversative nuance is guaranteed._

//         See above point.

//         \item _It is difficult to translate to English._
...
//         \item _Adversative nuance is not guaranteed._
...
//         #textred[[非意志、不自然] \st{雨に#ruby[止][や]まれた。 (#ruby[止][や]む: to cease/stop/be over (intransitive))]}
...
//     \item However, if the speaker likes アンさん and sees 田中さん as a love rival, then the actions of アンさん and 田中さん in A1 and B1 would be unpleasant, even if their actions did not _directly_ affect the speaker. The speaker would therefore use the _indirect_ passive voice to express their feelings.
...
//     \item{} [C2、受動文] *田中さんは*アルバイトに休まれて、*とても#ruby[困][こま]りました。* (Tanaka-san had a day off taken on him by the part-timer, and was very troubled.; 休む: to take a day off (intransitive))
...
//     [直接受身] 私は先生*{に\st{/から*}}お寿司屋さんに#ruby[誘][さそ]われた。 (I was invited to the Sushi restaurant by teacher.; #ruby[誘][さそ]う: to invite (transitive))

//     \item For _formal_ passivised verbs that refer to a give-receive transaction (same as previous point but formal), and for verbs that involve creation of a work, によって is used. As an exception, the #ruby[罰][ばっ]する verb (to punish (transitive)) must use によって.
