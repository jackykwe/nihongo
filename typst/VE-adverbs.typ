...
}  % inner specification options
{
    ...
    \ruby{全部}{ぜん|ぶ} & entirely/wholly/altogether & also a noun; \href{https://dictionary.goo.ne.jp/thsrs/13845/meaning/m0u}{[goo]} \\
    \ruby{全体}{ぜん|たい} & wholly/entirely & \href{https://dictionary.goo.ne.jp/thsrs/13845/meaning/m0u}{[goo]} \\
...
}  % inner specification options
{
    ...
    よく & frequently/often & (\ruby{良}{よ}く); also in Table~\ref{tbl:appendix-vocab-adverbs-attitude} \\
...
}  % inner specification options
{
    ...
    よく & nicely/properly/well/skilfully & (\ruby{良}{よ}く); also in Table~\ref{tbl:appendix-vocab-adverbs-time} \\
    % & & \\
    \midrule
    ...
    ほとんど & almost/nearly/mostly/practically/virtually/basically/just about & (\ruby{殆}{ほとん}ど), also in Table~\ref{tbl:appendix-vocab-adjectives-amounts-and-sizes} \\
    % & & \\
    % & & \\
    \midrule
    \midrule
...
}  % inner specification options
{
    ...
    % & & \\
    \midrule
    ほとんど<negative> & hardly/barely/scarcely/little & (\ruby{殆}{ほとん}ど), also in Table~\ref{tbl:appendix-vocab-adverbs-attitude} \\
    ...
    ほとんど & large majority/proportion; most/almost all of & (\ruby{殆}{ほとん}ど), also in Table~\ref{tbl:appendix-vocab-adverbs-attitude} \\
    % & & \\
    \midrule
