...
\subsubsection{Truth and reality}
\begin{center}
\centering
\resizebox{\linewidth}{!}{%
% Help: \multicolumn{2}{c}{}, \multirow{2}{*}{}, cmidrule(l){3-5}
\begin{tabular}{@{}lll@{}}
    ...
    \midrule
    \midrule
    \toprule\ruby{信用}{しん|よう} & trust/confidence/reputation (past) & \href{https://japanese.stackexchange.com/q/24275}{[SE]} \\
    \ruby{信頼}{しん|らい} & trust/confidence/reliance/faith (future) & \href{https://japanese.stackexchange.com/q/24275}{[SE]} \\
    % & & \\
\bottomrule
\end{tabular}%f
}
\captionof{table}{Nouns: truth and reality.}
\label{tbl:appendix-vocab-nouns-truth-and-reality}
\end{center}
