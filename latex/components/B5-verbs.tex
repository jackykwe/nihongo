...
\begin{NiceTabular}{@{}lclllcll@{}}
    ...
    \vit \multirow{2}{*}{\ruby{上}{あ}げる} & \multirow{2}{*}{る} & to raise; to do up (one's hair); to fly (kite)/launch (fireworks) & & \multirow{2}{*}{\ruby{上}{あ}がる} & \multirow{2}{*}{う} & to rise (focus on destination); to enter (from outside); to enrol/promote (school); & \multirow{2}{*}{\href{https://dictionary.goo.ne.jp/thsrs/15966/meaning/m1u/}{[goo]}, \href{https://hugkum.sho.jp/582833}{[HK]}} \\
...
\begin{NiceTabular}{@{}lclllcll@{}}
    ...
    \midrule
    \midrule
    \vit \multirow{2}{*}{\ruby{切}{き}る} & \multirow{2}{*}{\exception{う}} & to cut/open (sealed); turn off (lights/appliance); hang up & & \multirow{2}{*}{\ruby{切}{き}れる} & \multirow{2}{*}{る} & to break/snap; run out/stop working/expire; be disconnected; & \\
    \vit & & (conversation); shuffle/discard (cards/tiles); punch (ticket) & & & & be shuffled (cards/tiles); run out (stock); break up & \\
    <stem>\ruby{切}{き}る & \exception{う} & \hl{to be able to} do <stem> completely & \aux & & & & \\
    % & & & & & & & \\
    \midrule
    \midrule
...
\begin{NiceTabular}{@{}lclllcll@{}}
    ...
    \textbf{Action} & \textbf{Cat.} & \textbf{Meaning} & \textbf{Notes} & \textbf{Action} & \textbf{Cat.} & \textbf{Meaning} & \textbf{Notes} \\
    \toprule
    \vit \ruby{変}{か}える & る & to alter/transform/convert/vary/change & & \ruby{変}{か}わる & う & to change; to move to (new place) & \\
