...
\section{\ruby{普通名詞}{ふ|つう|めい|し} (nouns)}
...
\emph{Read the main articles on \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{JWA} and \href{https://kino92.kagohara.net/2019/01/698.htm/}{KH}.}
...
\end{itemize}
The readings of the intercardinal and secondary intercardinals are simply the concatenation of the unmodified constituent 音読み readings. The only exception is when cardinals describing direction spans come together, in whcih case \emph{rendaku} occurs, so we have \ruby{東西}{とう|ざい} and \ruby{南北}{なん|ぼく}.
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    \ruby{東西南北}{とう|ざい|なん|ぼく} & east, west, south and north (Japanese order) & \yojijukugo; \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{東}{ひがし} & east (cardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{西}{にし} & west (cardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{南}{みなみ} & south (cardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{北}{きた} & north (cardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    ...
    % & & \\
    \midrule
    \ruby{南東}{なん|とう} & southeast (intercardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{南西}{なん|せい} & southwest (intercardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{北東}{ほく|とう} & northeast (intercardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    \ruby{北西}{ほく|せい} & northwest (intercardinal direction) & \href{https://www.japanesewithanime.com/2017/03/north-south-east-west-in-japanese.html}{[JWA]} \\
    ...
    [お]そば & near/close/beside/vicinity/proximity/besides/while & (\ruby{側}{そば}/\ruby{傍}{そば}); [honorific]; \href{https://dictionary.goo.ne.jp/word/\%E5\%81\%B4\_\%28\%E3\%81\%9D\%E3\%81\%B0\%29/}{[goo]} \\
    % & & \\
    \midrule
    ...
    \midrule
    \midrule
    \ruby{昇進}{しょう|しん} & promotion in rank (of person) & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/8994/meaning/m0u/}{[goo]} \\
    \ruby{昇格}{しょう|かく} & promotion in status (of person/institution) & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/8994/meaning/m0u/}{[goo]} \\
    \ruby{昇任}{しょう|にん} & promotion/advancement (of person) & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/8994/meaning/m0u/}{[goo]} \\
    \ruby{格上}{かく|あ}げ & upgrade/promotion in status & also a verb \\
    \ruby{昇級}{しょう|きゅう} & upgrading/promotion/advancement in grade/class/rank & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/8994/meaning/m0u/}{[goo]} \\
...
}  % inner specification options
{
    ...
    \ruby{終車}{しゅう|しゃ} & last train/bus (of the day) & (abbreviation of \ruby{終発電車}{しゅう|はつ|でん|しゃ}); \href{https://ja.wikipedia.org/wiki/\%E7\%B5\%82\%E9\%9B\%BB}{[Wiki]} \\
...
}  % inner specification options
{
    ...
    \ruby[g]{田舎}{いなか} & rural area/countryside; hometown & \\
...
}  % inner specification options
{
    ...
    マグロ & tuna & (\ruby{鮪}{まぐろ}) \\
    エビ & prawn/shrink/lobster & (\ruby[g]{海老}{えび}) \\
    りんご & apple & (\ruby{林檎}{りん|ご}) \\
    いちご & strawberry & (\ruby{苺}{いちご}) \\
    バナナ & banana & \\
    ゆず & yuzu fruit & (\ruby[g]{柚子}{ゆず}) \\
    わさび & wasabi/Japanese horseradish & (\ruby[g]{山葵}{わさび}) \\
    \ruby{桃}{もも} & peach & \\
    ...
    デザート & dessert & \\
    のり & edible seaweed & (\ruby[g]{海苔}{のり})  \\
...
}  % inner specification options
{
    ...
    % & & \\
    \midrule
    \ruby{先}{さき} & first/before/ahead of; previous/prior/former/recent/last & \href{https://ja.hinative.com/questions/19806443}{[HN]}; also in Table~\ref{tbl:appendix-vocab-nouns-directions} \\
...
}  % inner specification options
{
    ...
    \ruby{全部}{ぜん|ぶ} & all/everything & also an adverb; \href{https://dictionary.goo.ne.jp/thsrs/13845/meaning/m0u}{[goo]} \\
...
}  % inner specification options
{
    ...
    いかなる & any kind of/whatsoever/whatever & (\ruby{如何}{い|か}なる); \href{https://ja.hinative.com/questions/20629286}{[HN]} \\
    ...
    % & & \\
    \midrule
    \ruby{単}{たん}なる & simple/nothing deeper (joke/coincidence) & \href{https://ja.hinative.com/questions/8297591}{[HN]} \\
    ほんの & very little/insignificant/only (e.g.\ distance/time/occurrence); mere (e.g.\ child) & (\ruby{本}{ほん}の); \href{https://ja.hinative.com/questions/8297591}{[HN]} \\
    ただの & ordinary/average/nothing special & (\ruby{只}{ただ}の); \href{https://ja.hinative.com/questions/8297591}{[HN]} \\
    ...
    \ruby{来}{きた}る & coming/upcoming (〜◯\ruby{月}{がつ}) & \href{https://ja.hinative.com/questions/21678745}{[HN]} \\
    \ruby{明}{あ}くる & next/following (〜\ruby{日}{ひ}/〜\ruby{朝}{あさ}/\ruby{年}{とし} etc.) & \href{https://ja.hinative.com/questions/21678745}{[HN]} \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    \ruby{子}{こ}ども & child & \ruby{子供}{こ|ども} may be offensive; \href{https://www.reddit.com/r/LearnJapanese/comments/hkwop3/\%E5\%AD\%90\%E4\%BE\%9B\_vs\_\%E5\%AD\%90\%E3\%81\%A9\%E3\%82\%82_advice/}{[r]}; also in Table~\ref{tbl:appendix-vocab-nouns-family} \\
    ...
    \ruby{方}{かた} & person/lady/gentleman & honorific; \href{https://ja.hinative.com/questions/78293}{[HN]}; also in Table~\ref{tbl:appendix-vocab-nouns-production} \\
    ...
    ライアー & liar & \\
    太〜 & fat/fatty & \prefix \\
    おやじ & middle-aged man/geezer & (\ruby[g]{親父}{おやじ}); familiar; also in Table~\ref{tbl:appendix-vocab-nouns-family} \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    おやじ & one's father/pops & (\ruby[g]{親父}{おやじ}); familiar; also in Table~\ref{tbl:appendix-vocab-nouns-roles-and-occupations} \\
...
}  % inner specification options
{
    ...
    \ruby[g]{白髪}{しらが}/\ruby{白髪}{はく|はつ} & white/grey hair & \\
    ...
    あくび & yawn/yawning & (\ruby[g]{欠伸}{あくび}) \\
    キス & kiss & also a verb \\
...
}  % inner specification options
{
    ...
    \ruby[g]{浴衣}{ゆかた} & yukata/light cotton kimono worn in summer or as bathrobe & \\
    % & & \\
    \midrule
    \midrule
    ショーツ & shorts & \\
...
}  % inner specification options
{
    ...
    \ruby{不幸}{ふ|こう} & な & unhappy/sorrowful/misfortunate/disastrous; bereavement/death (usu.\ of relative) & \href{https://dictionary.goo.ne.jp/thsrs/5311/meaning/m0u/}{[HN]} \\
    \ruby{不幸}{ふ|しあわ}せ & unhappiness/misfortune/ill luck & also an adjective; \href{https://dictionary.goo.ne.jp/thsrs/5311/meaning/m0u/}{[HN]} \\
    % & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \textbf{Name} & \textbf{Meaning} & \textbf{Notes} \\
    \midrule
    \ruby{方}{ほう} & direction/way/side/area (in particular direction); type/category; one side of comparison; square length & \href{https://ja.hinative.com/questions/78293}{[HN]} \\
    \ruby{方}{かた} & method & \suffix; \href{https://ja.hinative.com/questions/78293}{[HN]}; also in Table~\ref{tbl:appendix-vocab-nouns-roles-and-occupations} \\
    ...
    \midrule
    \midrule
    カッコ & (opening) bracket/parenthesis & (\ruby{括弧}{かっ|こ}); \href{https://japanese.stackexchange.com/a/56967}{[SE]} \\
    カッコとじ & closing bracket/parenthesis & (\ruby{括弧閉}{かっ|こ|と}じ); \href{https://japanese.stackexchange.com/a/56967}{[SE]} \\
    % & & \\
    \midrule
    \midrule
    ...
    ギャグ & gag/joke & \\
    オヤジギャグ & corny joke/dad joke (``dad gag'') & (\ruby[g]{親父}{おやじ}ギャグ); slang \\
    % & & \\
    \midrule
    \ruby{音}{おと} & sound & \\
    \ruby{音楽}{おん|がく} & music & \\
    ...
    \ruby[g]{真似}{まね} & imitating/copying/mimicry (usu. as <adj>\ruby[g]{真似}{まね}をする) & \\
    % & & \\
    \midrule
    \midrule
    ...
    \midrule
    \midrule
    \ruby{掃除}{そう|じ} & cleaning/sweeping/dusting/scrubbing & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/6207/meaning/m0u/}{[goo]} \\
    \ruby{清掃}{せい|そう} & cleaning/clean-up/garbage collection & also a verb, literary; \href{https://dictionary.goo.ne.jp/thsrs/6207/meaning/m0u/}{[goo]} \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    タバコ & tobacco/cigarette/cigar & (\ruby[g]{煙草}{たばこ}) \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    \ruby{生}{い}き\ruby[g]{甲斐}{がい} & reason for living/purpose in life & (\ruby{生}{い}きがい) \\
    % & & \\
    \midrule
    ...
    % & & \\
    \midrule
    \ruby[g]{風邪}{かぜ} & common cold/flu/influenza/inflammatory respiratory system illness (generic) & \\
    ...
    ゆず\ruby{湯}{ゆ} & yuzu bath/hot citron bath & (\ruby[g]{柚子}{ゆず}\ruby{湯}{ゆ}) \\
    % & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \ruby{白黒}{しろ|くろ} & monochrome; black and white; good and evil/right and wrong & \href{https://word-chi.ryu-bow.com/1656.html}{[WDC]} \\
    \ruby{黒白}{くろ|しろ} & black and white; good and evil/right and wrong & \href{https://word-chi.ryu-bow.com/1656.html}{[WDC]} \\
...
}  % inner specification options
{
    ...
    % & & \\
    \midrule
    \ruby[g]{八重}{やえ} & overlapping/multilayered/doubled (e.g.\ of flower petals) & \href{https://dictionary.goo.ne.jp/word/\%E5\%85\%AB\%E9\%87\%8D/}{[goo]}, \href{https://ja.wikipedia.org/wiki/\%E5\%85\%AB\%E9\%87\%8D}{[Wiki]} \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    \ruby{年}{とし}[を]\ruby{取}{と}った & old/aged (person) & \href{https://ja.hinative.com/questions/14498}{[HN]} \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    クラブ & club; nightclub; sports club; golf club & (\ruby[g]{倶楽部}{くらぶ}); also in Table~\ref{tbl:appendix-vocab-nouns-consumption} \\
...
}  % inner specification options
{
    ...
    \ruby{実際}{じっ|さい} & actuality/in practice (compared to expectation/theory) (usu.\ as \ruby{実際}{じっ|さい}の or \ruby{実際}{じっ|さい}は) & \href{https://ja.hinative.com/questions/23210866}{[HN]} \\
    ...
    % & & \\
    \midrule
    \ruby{確定}{かく|てい} & decision (clear) & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    \ruby{内定}{ないう|てい} & \{informal/internal/unofficial\} \{decision/offer (e.g.\ job)\} & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    \ruby{本決}{ほん|ぎ}まり & formal/official final decision & \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    \ruby{未定}{み|てい} & not decided/not yet fixed/undecided/pending/TBC & also an adjective; \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]}\\
    \ruby{所定}{しょ|てい} & predetermined/prescribed/designated/fixed in advance & \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    \ruby{暫定}{ざん|てい} & provisional/tentative decision & \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    \ruby{予定}{よ|てい} & plans/arrangement/decision made in advance & \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    \ruby{既定}{き|てい} & decided/established/fixed/prearranged/predetermined & \href{https://dictionary.goo.ne.jp/thsrs/13669/meaning/m0u/}{[goo]} \\
    % & & \\
    \midrule
    \ruby{決断}{けつ|だん} & decision (strong) & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/3217/meaning/m0u/}{[goo]} \\
    \ruby{決定}{けっ|てい} & decision & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/3217/meaning/m0u/}{[goo]} \\
    \ruby{判断}{はん|だん} & judgment & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/3217/meaning/m0u/}{[goo]} \\
    \ruby{断}{だん} & judgment & literary \href{https://dictionary.goo.ne.jp/thsrs/3217/meaning/m0u/}{[goo]} \\
    \ruby{判定}{はん|てい} & verdict/ruling/judgment (of judge/referee) & also a verb \\
    \ruby{断定}{だん|てい} & assertion/declaration/conclusion & also a verb; \href{https://dictionary.goo.ne.jp/thsrs/3217/meaning/m0u/}{[goo]} \\
    % & & \\
    \midrule
    \midrule
...
}  % inner specification options
{
    ...
    % & & \\
    \midrule
    \ruby{全体}{ぜん|たい} & whole/entirety & \href{https://dictionary.goo.ne.jp/thsrs/13845/meaning/m0u}{[goo]} \\
...
\subsection{Cosmic}
\emph{Read the main article on \href{https://www.sakuramani.com/the-solar-system-in-japanese/}{SM}. Read the differences between cosmic rocks at \href{https://www.amsmeteors.org/wp-content/uploads/2013/09/AMS-TERMINOLOGY-2015-EN-ENGLISH1.pdf}{AMS}.}
