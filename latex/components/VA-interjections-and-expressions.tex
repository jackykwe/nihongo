...
}  % inner specification options
{
    ...
    ありがとう[ございます] & thanks/thank you & (\ruby[g]{有[り]難}{ありがと}う[\ruby{御座}{ご|ざ}います]); [polite] \\
    ...
    \midrule
    \midrule
    つまらない\ruby{物}{もの}ですが & it's not much, but\dots (when giving a gift) & humble; (\ruby{詰}{つ}まらない\ruby{物}{もの}ですが); \href{https://www.youtube.com/shorts/HV4GmjgQZHw}{[KK]} \\
    % & & \\
    \midrule
    \midrule
