...
}  % inner specification options
{
    ...
    \ruby{取}{と}れあえず & first of all/right away & also in Tables~\ref{tbl:appendix-vocab-adverbs-time}, \ref{tbl:appendix-vocab-adverbs-knowledge-truth-and-reality} \\
...
}  % inner specification options
{
    ...
    \ruby{取}{と}れあえず & tentatively/for now/for the time being & also in Tables~\ref{tbl:appendix-vocab-adverbs-grammatical}, \ref{tbl:appendix-vocab-adverbs-knowledge-truth-and-reality} \\
    % & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \ruby{取}{と}れあえず & anyway & also in Tables~\ref{tbl:appendix-vocab-adverbs-grammatical}, \ref{tbl:appendix-vocab-adverbs-time} \\
    % & & \\
    \bottomrule
}
