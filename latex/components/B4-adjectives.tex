...
\begin{tabular}{@{}lcll@{}}
    ...
    すごい & い & amazing/great/wonderful/terrific & \\
...
\begin{tabular}{@{}lcll@{}}
    ...
    \textbf{Descriptor} & \textbf{Cat.} & \textbf{Meaning} & \textbf{Notes} \\
    \toprule
    うまい & い & skilful/good/delicious & (\ruby{上手}{う|ま}い) \\
...
\captionof{table}{Adjectives: truth and reality.}
\label{tbl:appendix-vocab-adjectives-truth-and-reality}
\end{center}
...
\begin{tabular}{@{}lcll@{}}
    ...
    すごい & い & vast (in numbers)/to a great extent & \\
    \midrule
