...
}  % inner specification options
{
    ...
    \vit \ruby{破}{やぶ}る & う & to break/tear/destroy; to break through (defences); to surpass (record) & also in Table~\ref{tbl:appendix-vocab-verbs-conflict-and-resolution} & \ruby{破}{やぶ}れる & る & to break/collapse/be torn/worn out/ruined & \\
