...
}  % inner specification options
{
    ...
    % & & & & & & & \\
    \midrule
    \viteq \ruby{遠慮}{えん|りょ}する & to refrain from (esp.\ タバコ) & & \ruby{遠慮}{えん|りょ}する & E & to hold back/reserve/constrain/restrain oneself & & \\
    % & & & & & & & \\
    \midrule
...
}  % inner specification options
{
    ...
    <v te>しまう & う & to do completely & (\ruby{仕舞}{し|ま}う) & - & & & \\
    <v te>しまう & う & to do accidentally & (\ruby{仕舞}{し|ま}う) & - & & & \\
    % & & & & & & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    \vit \ruby{傷}{きず}つける & る & to wound/injure/hurt someone's feelings & & \ruby{傷}{きず}つく & う & to be wounded/get injured/get hurt feelings & \\
    % & & & & & & & \\
    \midrule
    \midrule
