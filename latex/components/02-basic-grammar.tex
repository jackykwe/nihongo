...
\begin{tabular}{@{}crrrrl@{}}
    ...
    \multirow{3}{*}{い-adjective} & 「」い & 「」\textblue{かった} & 「」\textblue{く[は]ない} & 「」\textblue{く[は]なかった} & 嬉しい、気持ち悪い、難しい \\
...
\begin{tabular}{@{}crrrrl@{}}
    ...
    \multirow{3}{*}{い-adjective} & 「」い & 「」\textwhite{かった} & 「」\textwhite{く[は]ない} & 「」\textwhite{く[は]なかった} & 嬉しい、気持ち悪い、難しい \\
    ...
    & 「」　む & 「」\textwhite{んだ} & 「」\textwhite{まない} & 「」\textwhite{まなかった} & 飲む、読む、\ruby{盗}{ぬす}む \\
    & 「」　ね & 「」\textwhite{んだ} & 「」\textwhite{なない} & 「」\textwhite{ななかった} & 死ね \\
    & 「」　ぶ & 「」\textwhite{んだ} & 「」\textwhite{ばない} & 「」\textwhite{ばなかった} & 遊ぶ \\
    & 「」　る & 「」\textwhite{った} & 「」\textwhite{らない} & 「」\textwhite{らなかった} & \textred{知る}、\textred{切る}、\textred{\ruby{帰}{かえ}る}、\textred{\ruby{走}{はし}る}、\ruby{降}{ふ}る \\
    & ある & \textwhite{あった} & \textwhite{ない} & \textwhite{なかった} & \\
    & 「」　つ & 「」\textwhite{った} & 「」\textwhite{たない} & 「」\textwhite{たなかった} & 待つ \\
    & 「」　う & 「」\textwhite{った} & 「」\textwhite{わない} & 「」\textwhite{わなかった} & 買う、\ruby{会}{あ}う \\ \midrule
...
\begin{itemize}
    \item と: inclusive noun connector (exclusive list or together-action). \textred{It is used \emph{between} nouns in a list, not as a marker at the end of each noun.} It is similar to 「も」 in terms of \ul{inclusivity}. It can also be used to show an \ul{action was done together} with something or someone.
...
\begin{tabular}{@{}ccllll@{}}
    ...
    \multirow{2}{*}{\textbf{Category}} & \multirow{2}{*}{\textbf{の purpose}} & \multicolumn{2}{c}{\textbf{Positive}} & \multicolumn{2}{c}{\textbf{Negative}} \\ \cmidrule(lr){3-4} \cmidrule(l){5-6}
    & & \textbf{Present} & \textbf{Past} & \textbf{Present} & \textbf{Past} \\ \midrule
    Noun & Possession & 「」\textgreen{の[だ]$^*$} & \textlightgrey{「」のだった} & \textlightgrey{「」のじゃない} & \textlightgrey{「」のじゃなかった} \\
    な-adjective/い-adjective/verb & Generic noun & 「」\textgreen{の} & 「」<conj>\textgreen{の} & 「」<conj>\textgreen{の}  & 「」<conj>\textgreen{の} \\ \midrule
    Noun/な-adjective & Explanatory (Formal) & 「」\textgreen{\textred{な}の[だ]$^{**}$。} & 「」だった\textgreen{の[だ]$^{**}$。} & 「」じゃない\textgreen{の[だ]$^{**}$。}  & 「」じゃなかった\textgreen{の[だ]$^{**}$。} \\
    Noun/な-adjective & Explanatory (Casual) & 「」\textgreen{\textred{な}んだ。}  & 「」だった\textgreen{んだ。} & 「」じゃない\textgreen{んだ。}  & 「」じゃなかった\textgreen{んだ。} \\
    ...
    % Noun/な-adjective & Explanatory (Casual II) & 「」\textgreen{\textred{な}んだ。}  & 「」\textlightgrey{\textred{な}んだった。} & 「」\textgreen{\textred{な}んじゃない。}  & 「」\textlightgrey{\textred{な}んじゃなかった。} \\ \midrule
    Noun/な-adjective & Explanatory (Casual II) &  & 「」\textlightgrey{\textred{な}んだった。} & 「」\textgreen{\textred{な}んじゃない。}  & 「」\textlightgrey{\textred{な}んじゃなかった。} \\ \midrule
    い-adjective/verbs & Explanatory (Formal)) & 「」\textgreen{の[だ]$^{**}$。} & 「」<conj>\textgreen{の[だ]$^{**}$。} & 「」<conj>\textgreen{の[だ]$^{**}$。} & 「」<conj>\textgreen{の[だ]$^{**}$。} \\
    い-adjective/verbs & Explanatory (Casual) & 「」\textgreen{んだ。} & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだ。} \\
    % い-adjective/verbs & Explanatory III & 「」\textlightgrey{のだ。} & 「」\textlightgrey{のだった。} & 「」\textlightgrey{のじゃない。} & 「」\textlightgrey{のじゃなかった。} \\
    % い-adjective/verbs & Explanatory (Casual II) & 「」\textgreen{んだ。} & 「」\textgreen{んだった。} & 「」\textgreen{んじゃない。} & 「」\textgreen{んじゃなかった。} \\ \bottomrule
    い-adjective/verbs & Explanatory (Casual II) &  & 「」\textgreen{んだった。} & 「」\textgreen{んじゃない。} & 「」\textgreen{んじゃなかった。} \\ \bottomrule
\end{tabular}%
}
\caption{の particle usage summary. 「」 is a dictionary-form placeholder; [] is optional; \textgreen{green means additive} (without modifying the dictionary-form); \textblue{blue means substitutive} (modifies the dictionary-form); \textred{red means exception}. $^*$: だ is the optional declarative/assertive present state-of-being marker. **: だ is used in masculine responses. \textred{な} is used by rule. \textlightgrey{Light grey ones are rarely used.} Casual I: attaching んだ to any tense of a noun/adjective/verb; Casual II: attaching んだ to the dictionary-form, then conjugating the だ. Both casual forms have slightly different nuances. \textred{\textbf{This section is downright confusing, I think it requires knowledge of how to ask questions (e.g.\ じゃない？じゃん？じゃないか？) as well as knowledge of polite form んです in order to truly appreciate these forms. Move on for now.}}}
...
\begin{description}
    ...
    E.g.\ \ruby{生}{う}まれたのはニューヨークです。(I was born in New York; 生まれる: to be born)
