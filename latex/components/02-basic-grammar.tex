...
\begin{itemize}
    ...
    \emph{A \textbf{direct object} is the person or thing that directly receives the action or effect of the verb. It answers the question ``what'' or ``whom''. \textred{(\textbf{CAUTION}: Using the ``The subject verbed what?'' as a test for transitivity is \textbf{not foolproof} and doesn't always work! It's merely a crutch.)} An \textbf{indirect object} answers the question ``for what,'' ``of what,'' ``to what,'' ``for whom,'' ``of whom,'' or ``to whom'' and accompanies a direct object.} \href{https://www.britannica.com/dictionary/eb/qa/Direct-and-Indirect-Objects}{(Source)}
...
\textpurple{There are no easy tricks to tell whether a verb is transitive or not. There are no simple rules that say a particular 送り仮名 implies a certain transitivity. The verb corpus is a mess!}

\textred{\textbf{\ul{DO NOT}} confuse transitivity with passiveness.} English dictionaries like to define verbs using the "to \dots" construct, and this is carried over to English-Japanese dictionaries. Intransitive verbs are \emph{often} expressed in passive voice, but
\begin{align}
...
\begin{tabular}{@{}cclllll@{}}
    \toprule
    \multirow{2}{*}{\textbf{の Purpose}} & \multirow{2}{*}{\textbf{Category}}  & \multirow{2}{*}{\textbf{Dictionary form}} &  \multicolumn{2}{c}{\textbf{Positive}}                                                     & \multicolumn{2}{c}{\textbf{Negative}}                                                                 \\ \cmidrule(lr){4-5} \cmidrule(l){6-7}
                                         &                                     &                                           & \textbf{Present}                            & \textbf{Past}                                & \textbf{Present}                                   & \textbf{Past}                                    \\ \midrule
    Possession                           & Noun                                & 「」                                      & 「」\textgreen{の[だ]$^*$}                  & \textlightgrey{「」のだった}                 & \textlightgrey{「」のじゃない}                     & \textlightgrey{「」のじゃなかった}               \\ \midrule
    \multirow{2}{*}{Generic noun}        & \multirow{1}{*}{な-adjective}       & 「」                                      & 「」\textred{な}\textgreen{の}              & 「」だった\textgreen{の}                     & 「」じゃない\textgreen{の}                         & 「」じゃなかった\textgreen{の}                   \\
                                         & \multirow{1}{*}{い-adjective/verb}  & 「」                                      & 「」\textgreen{の}                          & 「」<conj>\textgreen{の}                     & 「」<conj>\textgreen{の}                           & 「」<conj>\textgreen{の}                         \\ \midrule
    \multirow{8.5}{*}{Explanatory}       & \multirow{4}{*}{Noun/な-adjective}  & 「」                                      & 「」\textred{な}\textgreen{の[だ]$^{**}$。} & 「」だった\textgreen{の[だ]$^{**}$。}        & 「」じゃない\textgreen{の[だ]$^{**}$。}            & 「」じゃなかった\textgreen{の[だ]$^{**}$。}      \\
