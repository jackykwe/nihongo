...
\begin{itemize}
    ...
    E.g.\ \ruby{街}{まち}\textbf{を}ぶらぶら\ruby{歩}{ある}く。(ぶらぶら: aimlessly, 歩く: walk).

    E.g.\ \ruby{高速道路}{こう|そく|どう|ろ}\textbf{を}\ruby{走}{はし}る。(走る: run)
