...
\begin{tabular}{@{}crrrrl@{}}
    ...
    な-adjective & 「」\textwhite{な} & 「」\textwhite{だった} & 「」\textwhite{じゃない} & 「」\textwhite{じゃなかった} & 綺麗、好き、\textred{嫌い}  \\ \midrule
    ...
    \multirow{10}{*}{う-verb} & 「」　す & 「」\textwhite{した} & 「」\textwhite{さない} & 「」\textwhite{さなかった} & 話す \\
...
\begin{itemize}
    ...
    \item の: possession (owner-の-ownee) marker, generic noun, or explanatory particle. The の particle has three uses:
    \begin{description}
        \item[Possession marker]
        \item[Generic noun]
        \item[Explanatory]
    \end{description}
\end{itemize}
