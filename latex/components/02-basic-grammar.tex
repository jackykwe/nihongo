...
\begin{itemize}
    ...
    Regarding conjugation, one い-adjective family is an exception: いい. Historically, the word for good changed over time from \ruby{良}{よ}い to いい, but conjugations are still take 良い as the base. Same applies to \ruby{格好}{かっ|こ}いい, which takes 格好良いas the base. Therefore:
    \begin{itemize}
