...
\begin{tabular}{@{}crrrrl@{}}
    \toprule
    \multirow{2}{*}{\textbf{Category}} & \multicolumn{2}{c}{\textbf{Positive}} & \multicolumn{2}{c}{\textbf{Negative}} & \multirow{2}{*}{\textbf{Examples}} \\ \cmidrule(lr){2-3} \cmidrule(lr){4-5}
...
\begin{tabular}{@{}crrrrl@{}}
    ...
    \multirow{2}{*}{\textbf{Category}} & \multicolumn{2}{c}{\textbf{Positive}} & \multicolumn{2}{c}{\textbf{Negative}} & \multirow{2}{*}{\textbf{Examples}} \\ \cmidrule(lr){2-3} \cmidrule(lr){4-5}
    & \textbf{Present} & \textbf{Past} & \textbf{Present} & \textbf{Past} \\ \midrule
    Noun/な-adjective & 「」\textwhite{[だ]} & 「」\textwhite{だった} & 「」\textwhite{じゃない} & 「」\textwhite{じゃなかった} & 学生、友達 \\ \midrule
    な-adjective & 「」\textwhite{な} & 「」\textwhite{だった} & 「」\textwhite{じゃない} & 「」\textwhite{じゃなかった} & 元気、綺麗、好き、\textred{嫌い}  \\ \midrule
    \multirow{3}{*}{い-adjective} & 「」い & 「」\textwhite{かった} & 「」\textwhite{く[は]ない} & 「」\textwhite{く[は]なかった} & 高い、難しい、おいしい \\
    & いい & \textwhite{よ}\textwhite{かった} & \textwhite{よ}\textwhite{く[は]ない} & \textwhite{よ}\textwhite{く[は]なかった} & \\
    & かっこいい & かっこ\textwhite{よ}\textwhite{かった} & かっこ\textwhite{よ}\textwhite{く[は]ない} & かっこ\textwhite{よ}\textwhite{く[は]なかった} & \\ \midrule
    \multirow{10}{*}{う-verb} & 「」　す & 「」\textwhite{した} & 「」\textwhite{さない} & 「」\textwhite{さなかった} & 話す、出す \\
    & 「」　く & 「」\textwhite{いた} & 「」\textwhite{かない} & 「」\textwhite{かなかった} & 聞く、書く、描く \\
    & 行　く & 行\textwhite{った} & 行\textwhite{かない} & 行\textwhite{かなかった} & \\
    & 「」　ぐ & 「」\textwhite{いだ} & 「」\textwhite{がない} & 「」\textwhite{がなかった} & 泳ぐ \\
    & 「」　む & 「」\textwhite{んだ} & 「」\textwhite{まない} & 「」\textwhite{まなかった} & 飲む \\
    & 「」　ね & 「」\textwhite{んだ} & 「」\textwhite{なない} & 「」\textwhite{ななかった} & 死ね \\
    & 「」　ぶ & 「」\textwhite{んだ} & 「」\textwhite{ばない} & 「」\textwhite{ばなかった} & 遊ぶ \\
    & 「」　る & 「」\textwhite{っだ} & 「」\textwhite{らない} & 「」\textwhite{らなかった} & ある、\textred{\ruby{帰}{かえ}る} \\
    ...
    % \multirow{3.85}{*}{Exception verb} & 「」する & 「」した & 「」しない & 「」しなかった & \\[0.5em]
    \multirow{3.5}{*}{Exception verb} & 「」する & 「」\textwhite{した} & 「」\textwhite{しない} & 「」\textwhite{しなかった} & 勉強する \\[0.5em]
    & \ruby{来}{く}る & 来\textwhite{た} & 来\textwhite{ない} & 来\textwhite{なかった} & \\
    & くる & \textwhite{き}\textwhite{た} & \textwhite{こ}\textwhite{ない} & \textwhite{こ}\textwhite{なかった} & \\ \bottomrule
\end{tabular}%
}
...
\begin{itemize}
    ...
    E.g.\ いい友達に\ruby{会}{あ}った。(Met good friend; past tense of \ruby{会}{あ}う.)

    E.g.\ ジムは\ruby{医者}{い|しゃ}になる。(Jim will become doctor; なる: become)
    ...
    E.g.\ \ruby{勝}{か}ちへ\ruby{向}{む}かう。(Go towards victory.)
    \item で: contextual particle; ``by way of''. It provides supplementary context: where, what, how.

    E.g.\ \ruby{映画館}{えい|が|かん}で見た。(Saw at movie theatre.)

    E.g.\ バスで帰る。(Go home by bus.)

    E.g.\ レストランで\ruby{昼}{ひる}ご飯を食べった。(Ate lunch at restaurant.)
\end{itemize}
...
\begin{itemize}
    \item 私が\ruby{電気}{でん|き}をつけた。(I turned on the lights; past tense of つける)

    電気を\ruby{消}{け}す。(Turn off the lights.)
    ...
    \item 誰が\ruby{窓}{まど}を\ruby{開}{あ}けた？ (Who opened the window?; 窓: window)

    窓がどうして\ruby{開}{ひら}いた？ (Why did the window open?; past tense of 開く; \textred{incorrect to use を here as 開く is intransitive and doesn't have any active agent})
    \item 部屋\textbf{を}\ruby{出}{で}た。(past tense of 出る)
\end{itemize}

\subsubsection{\ruby{何}{なに}で and \ruby{何}{なん}で in questions}
``What'' is expressed as \textbf{\ruby{何}{なに}}. ``Why'' is expressed as どうして (proper)、なぜ (forceful)、\textbf{\ruby{何}{なん}で (colloquial)}. Note that \ruby{何}{なん}で has nothing to do with the で particle; it is a completely separate word.
...
\begin{itemize}
    ...
    E.g.\ 先生と\ruby{会}{あ}った。(Met with teacher.)
    ...
    \begin{description}
        ...
        \item[Generic noun] The の particle can be suffixed to adjective-phrases and verb-phrases to represent a generic noun, taking the place of an actual noun. This usage \ul{allows us to treat adjectives, adjective-phrases, verbs and verb-phrases as nouns using a の suffix}. Then, particles applicable to nouns can be used as a suffix to the noun-phrase: は、も、が、を.

        E.g.\ (な-adjectives) \textbf{静かなの}が、アリスの部屋だ。(Quiet one is room of Alice.) \textred{(Note that the な cannot be dropped! All previous rules still apply.)} 「静かな部屋が、アリスのだ。」(``The quiet room is Alice's.'') is also ok.

        E.g.\ (い-adjectives) \textbf{白いの}は、かわいい。(Thing that is white is cute.)

        E.g.\ (adjective-phrases) \textbf{毎日勉強するの}は大変。(Studying every day is tough.)
        ...
        静かな部屋が、アリスのだ。
        \item[Abstract noun/explanatory] の as a sentence-ending particle (after a clause-ending verb or い-adjective) conveys an explanatory tone. It represents the abstract noun ``the thing is...''. It can also be used as a suffix to な-adjectives or state-of-being noun-phrases; in those cases \textbf{なの} must be used, just as な was required in their conjugation rules (Table~\ref{tbl:grammar-conjugation-summary}), in order to differentiate it from the possession marker or generic noun purposes of の.

        E.g.\ \ruby{今}{いま}は\ruby{忙}{いそが}しいの？今は忙しいの[だ]。(忙しい: busy; the absence of the trailing だ in the response is feminine; adult males add the だ in the response; \textred{だ cannot be used in the question})

        E.g.\ ジム\textbf{の}だ。(It belongs to Jim.)

        E.g.\ ジム\textbf{なの}だ。(It is Jim; with explanatory tone.)

        The のだ sentence-end expression is typically substituted by \textbf{んだ} as it's easier to say. んだ is however also used with all forms of nouns, adjectives, and verbs, and has its own set of conjugation rules.
...
\begin{tabular}{@{}ccllll@{}}
    \toprule
    \multirow{2}{*}{\textbf{Category}} & \multirow{2}{*}{\textbf{の purpose}} & \multicolumn{2}{c}{\textbf{Positive}} & \multicolumn{2}{c}{\textbf{Negative}} \\ \cmidrule(lr){3-4} \cmidrule(l){5-6}
    & & \textbf{Present} & \textbf{Past} & \textbf{Present} & \textbf{Past} \\ \midrule
    ...
    い-adjective/verbs & Explanatory I & 「」<conj>\textgreen{の[だ]。} & 「」<conj>\textgreen{の[だ]。} & 「」<conj>\textgreen{の[だ]。} & 「」<conj>\textgreen{の[だ]。} \\
    い-adjective/verbs & Explanatory II & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだ。} \\
    い-adjective/verbs & Explanatory III & 「」<conj>\textlightgrey{のだ。} & 「」<conj>\textlightgrey{のだった。} & 「」<conj>\textlightgrey{のじゃない。} & 「」<conj>\textlightgrey{のじゃなかった。} \\
    い-adjective/verbs & Explanatory IV & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだった。} & 「」<conj>\textgreen{んじゃない。} & 「」<conj>\textgreen{んじゃなかった。} \\ \bottomrule
\end{tabular}%
}
...
\begin{tabular}{@{}ccllll@{}}
    ...
    & & \textbf{Present} & \textbf{Past} & \textbf{Present} & \textbf{Past} \\ \midrule
    Noun & Possession & 「」\textgreen{の[だ]$^*$} & ? & ? & ? \\
    な-adjective/い-adjective/verb & Generic noun & 「」\textgreen{の} & 「」<conj>\textgreen{の} & 「」<conj>\textgreen{の}  & 「」<conj>\textgreen{の} \\ \midrule
    Noun/な-adjective & Explanatory I & 「」\textgreen{\textred{な}の[だ]$^{**}$。} & 「」<conj>\textgreen{の[だ]$^{**}$。} & 「」<conj>\textgreen{の[だ]$^{**}$。}  & 「」<conj>\textgreen{の[だ]$^{**}$。} \\
    Noun/な-adjective & Explanatory II & 「」\textgreen{\textred{な}んだ。}  & 「」<conj>\textgreen{んだ。} & 「」<conj>\textgreen{んだ。}  & 「」<conj>\textgreen{んだ。} \\
    Noun/な-adjective & Explanatory III & 「」\textlightgrey{\textred{な}のだ。}  & 「」\textlightgrey{\textred{な}のだった。} & 「」\textlightgrey{\textred{な}のじゃない。}  & 「」\textlightgrey{\textred{な}のじゃなかった。} \\
    Noun/な-adjective & Explanatory IV & 「」\textgreen{\textred{な}んだ。}  & 「」\textlightgrey{\textred{な}んだった。} & 「」\textgreen{\textred{な}んじゃない。}  & 「」\textlightgrey{\textred{な}んじゃなかった。} \\ \midrule
    ...
    い-adjective/verbs & Explanatory III & 「」\textlightgrey{のだ。} & 「」<conj>\textlightgrey{のだった。} & 「」<conj>\textlightgrey{のじゃない。} & 「」<conj>\textlightgrey{のじゃなかった。} \\
    い-adjective/verbs & Explanatory IV & 「」\textgreen{んだ。} & 「」<conj>\textgreen{んだった。} & 「」<conj>\textgreen{んじゃない。} & 「」<conj>\textgreen{んじゃなかった。} \\ \bottomrule
\end{tabular}%
}
\caption{State-of-being explanatory form conjugations. ??????????}
