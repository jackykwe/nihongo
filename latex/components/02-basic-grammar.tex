...
\begin{tabular}{@{}crrrrl@{}}
    ...
    \multirow{3}{*}{い-adjective}      & 「」い               & 「」\textblue{かった}                & 「」\textblue{くない}                  & 「」\textblue{くなかった}                  & 嬉しい、気持ち悪い、難しい \\
...
\begin{itemize}
    ...
    % E.g.\ 時間がなかった。それはパーチィーに行かなかった\textbf{\{の/ん\}}ですか？ (I didn't have time. Is that why you didn't go to the party?; polite)
