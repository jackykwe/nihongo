...
}  % inner specification options
{
    ...
    % & & & \\
    \midrule
    \ruby{無意識}{む|い|しき} & な & unconscious/involuntary/unintentional & \\
    % & & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \ruby{興味深}{きょう|み|ふ}い & い & very interesting/of great interest & \\
    % & & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    \ruby{色白}{いろ|じろ} & な & fair-skinned/ light-complexioned & \\
    \ruby{色黒}{いろ|ぐろ} & な & dark-skinned & \\
    % & & & \\
    \midrule
    \midrule
...
}  % inner specification options
{
    ...
    \ruby{曖昧}{あい|まい} & vague/ambiguous & & \href{https://ja.hinative.com/questions/4623371}{[HN]} \\
