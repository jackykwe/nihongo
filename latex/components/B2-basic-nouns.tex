...
\label{tbl:appendix-vocab-basic-nouns-counting-generic}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-people}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-age}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-thin-flat-things}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-drinks-cups-glasses}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-machines-vehicles}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-books}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-clothes}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-small-things}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-shoes-and-socks}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-houses}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-floors}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-big-animals}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-years}
\end{center}
...
\begin{tabular}{@{}lll@{}}
    ...
    \ruby{二日目}{ふ\exception{つ}|か|め}/\ruby{２日目}{ふ\exception{つ}|か|め}/\ruby{第二日}{だい|に|にち}/\ruby{第２日}{だい|に|にち} & second day & \\
    ...
    \ruby{六日目}{む\exception{い}|か|め}/\ruby{６日目}{む\exception{い}|か|め}/\ruby{第六日}{だい|ろく|にち}/\ruby{第６日}{だい|ろく|にち} & sixth day & \\
    \ruby{七日目}{\exception{なの}|か|め}/\ruby{７日目}{\exception{なの}|か|め}/\ruby{第七日}{だい|なな|にち}/\ruby{第７日}{だい|なな|にち} & seventh day & \\
    \ruby{八日目}{\exception{よう}|か|め}/\ruby{８日目}{\exception{よう}|か|め}/\ruby{第八日}{だい|はち|にち}/\ruby{第８日}{だい|はち|にち} & eighth day & \\
    \ruby{九日目}{ここの|か|め}/\ruby{９日目}{ここの|か|め}/\ruby{第九日}{だい|\textls{\exception{く}}|にち}/\ruby{第９日}{だい|\textls{\exception{く}}|にち} & ninth day & \\
...
\label{tbl:appendix-vocab-basic-nouns-counting-oclocks-and-hours}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-seconds}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-positions}
\end{center}
...
\label{tbl:appendix-vocab-basic-nouns-counting-occurrences}
\end{center}
