...
}  % inner specification options
{
    ...
    \midrule
    \SetCell[r=21]{c,m} う verb & Present-positive & \SetCell[c=2]{l,m} <$*$-end root>○ & & \SetCell[c=2]{l,m} <$*$-end root>\ruby{○}{〜い}ます。 & \\* \cmidrule[l]{2-6}
    ...
    & & \SetCell[c=2]{l,m} \ruby[<g>]{\textbf{な}くて}{ある\to} & & \SetCell[c=2]{l,m} \\
    % & & & & & \\
    \midrule
    \SetCell[r=7]{c,m} る verb & Present-positive & \SetCell[c=2]{l,m} {<る-end root>る} & & \SetCell[c=2]{l,m} {<る-end root>ます。} \\*
    ...
    % & & & & & \\
    \midrule
    \SetCell[r=7]{c,m} exception verb & Present-positive & 〜する & 〜くる & 〜します。 & 〜きます。 \\*
    ...
    & て-positive & 〜して & 〜きて & \SetCell[c=2]{l,m} - & \\*
    & て-negative & 〜しなくて & 〜こなくて & \SetCell[c=2]{l,m} - & \\
    % & & & & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    & nominaliser/generic noun & \textred{($*$)} <adj-phrase/v-phrase>\textlightgrey{\{}の\textlightgrey{,物,こと\}} & \S\ref{sec:noun-related-particles} \\
    ...
    けど/が & general connector & \textred{($*$)} <s1>\{けど\textlightgrey{/けれど/けれども}/が\}<s2> & \S\ref{sec:general-and-contradiction-connector-particles} \\
    & contradiction connector & \textred{($*$)} <s1>\{けど\textlightgrey{/けれど/けれども}/が\}<contradicting s2> & \S\ref{sec:general-and-contradiction-connector-particles} \\
