...
}  % inner specification options
{
    ...
    \midrule
    \SetCell[r=29]{c,m} う verb & Present-positive & \SetCell[c=2]{l,m} <$*$-end root>○ & & \SetCell[c=2]{l,m} <$*$-end root>\ruby{○}{〜い}ます。 & \\* \cmidrule[l]{2-6}
    ...
    & Volitional & \SetCell[c=2]{l,m} <$*$-end root>\ruby{○}{〜お}う & & \SetCell[c=2]{l,m} <$*$-end root>\ruby{○}{〜い}ましょう。 & \\
    % & & & & & \\
    \midrule
    \SetCell[r=13]{c,m} る verb & Dictionary & \SetCell[c=2]{l,m} {<る-end root>る} & & \SetCell[c=2]{l,m} {<る-end root>ます。} \\*
...
\begin{itemize}
    ...
    \item The conditional-positive form for all verbs is the same: change the last sound to \ruby{◯}{〜え} and attach ば.
    ...
    \item The volitional form for exception verbs are exceptions. They kind of follow the rules of る verbs: drop る and replace with よう, but additionally there's also a ``hint of past tense'' in there, explaining the こ sound in \ruby{来}{こ}よう.
\end{itemize}
...
}  % inner specification options
{
    ...
    \textbf{Class} & \textbf{Tense} & \SetCell[c=2]{c,m} \textbf{Casual schema} & & \SetCell[c=2]{c,m} \textbf{Polite schema} & \\
    \midrule
    \SetCell[r=19]{c,m} う verb & Dictionary & \SetCell[c=2]{l,m} <$*$-end root>○ & & \SetCell[c=2]{l,m} <stem>ます。 & \\* \cmidrule[l]{2-6}
    ...
    % & & & & & \\
    \midrule
    \SetCell[r=13]{c,m} る verb & Dictionary & \SetCell[c=2]{l,m} {<る-end root>る} & & \SetCell[c=2]{l,m} <stem>ます。 \\*
