...
\captionof{table}{Adverbs: appearance and style.}
\label{tbl:appendix-vocab-adverbs-appearance-and-style}
\end{center}
...
\captionof{table}{Adverbs: amounts and sizes.}
\label{tbl:appendix-vocab-adverbs-amounts-and-sizes}
\end{center}
