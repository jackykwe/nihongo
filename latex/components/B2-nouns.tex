...
}  % inner specification options
{
    ...
    \ruby{爆発}{ばく|はつ} & explosion/detonation/blast/blowing up/eruption (also of emotion) & \\
    % & & \\
    \bottomrule
}
...
}  % inner specification options
{
    ...
    \ruby{左}{ひだり} & left & \\
    \ruby{右}{みぎ} & right & \\
    \ruby{左折}{さ|せつ} & left turn & \\
    \ruby{右折}{う|せつ} & right turn & \\
...
}  % inner specification options
{
    ...
    \ruby{料理}{りょう|り} & cooking/cuisine/dish & \\
    \ruby{肉}{にく} & meat & \\
    \ruby{果物}{くだ|もの} & fruit & \\
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    \ruby{緊張}{きん|ちょう} & nervousness/stress/tension/strain; tension (between countries/groups) & \\
    \ruby{心配}{しん|ぱい} & worry/anxiety/uneasiness/fear & \\
    \midrule
    % & & \\
    \ruby{遠慮}{えん|りょ} & reserve/constraint/hesitation/tact/thoughtfulness; refraining/declining & \\
    % & & \\
    \midrule
    \ruby{涙}{なみだ} & tears & \\
...
}  % inner specification options
{
    ...
    \ruby{完成}{かん|せい} & completion/perfection/accomplishment & \\
    % & & \\
    \midrule
    \midrule
...
}  % inner specification options
{
    ...
    \midrule
    \ruby{日光浴}{にっ|こう|よく} & sunbathing/basking in the sun & \\
    % & & \\
    \midrule
...
}  % inner specification options
{
    ...
    \midrule
    \midrule
    \ruby{報告}{ほう|こく} & report/information & \\
